...
function Ga(a){for(;a.i.i;)try{var b=a.j(a.i);if(b)return a.i.B=!1,{value:b.value,done:!1}}catch(c){a.i.j=void 0,xa(a.i,c)}a.i.B=!1;if(a.i.l){b=a.i.l;a.i.l=null;if(b.Zb)throw b.Tb;return{value:b.return,done:!0}}return{value:void 0,done:!0}}
...
kd.prototype.isEmpty=function(){return null==this.ja};var ld="function"===typeof Symbol&&"symbol"===typeof Symbol()?Symbol(void 0):void 0;function md(a,b){Object.isFrozen(a)||(ld?a[ld]|=b:void 0!==a.sa?a.sa|=b:Object.defineProperties(a,{sa:{value:b,configurable:!0,writable:!0,enumerable:!1}}))}
function nd(a){var b;ld?b=a[ld]:b=a.sa;return null==b?0:b}
...
function sd(a,b){if(!Array.isArray(a))throw Error("cannot mark non-array as mutable");b?md(a,8):Object.isFrozen(a)||(ld?a[ld]&=-9:void 0!==a.sa&&(a.sa&=-9))}
...
function Wd(a,b,c,d){d=void 0===d?!1:d;var e=d;a.i||(a.i={});var f=a.i[c];if(f)b=f;else if(b=Id(Qd(a,c,e),b))a.i[c]=b,zd(a)&&rd(b.C);if(null==b)return b;zd(b)&&!zd(a)&&(b=b.Eb(),D(a,c,b.C,d),a.i[c]=b);return b}
...
function Yd(a,b,c,d){d=void 0===d?!1:d;var e=zd(a);b=Xd(a,b,c,d,e);a=Rd(a,c,d);if(!(c=e)&&(c=a)){if(!Array.isArray(a))throw Error("cannot check mutability state of non-array");c=!(nd(a)&8)}if(c){for(c=0;c<b.length;c++)(d=b[c])&&zd(d)&&!e&&(b[c]=b[c].Eb(),a[c]=b[c].C);sd(a,!0)}return b}
...
t(ge,be);ge.prototype.Eb=function(){return this};
...
t(I,ge);I.prototype.Eb=function(){if(zd(this)){var a={kb:!0};var b=zd(this);if(b&&!a.kb)throw Error("copyRepeatedFields must be true for frozen messages");var c=new this.constructor;this.Ha&&(c.Ha=this.Ha.slice());for(var d=this.C,e=0;e<d.length;e++){var f=d[e];if(e===d.length-1&&Ad(f))for(var g in f){var h=+g;Number.isNaN(h)?Pd(c)[g]=f[g]:je(this,c,h,f[g],b,a)}else je(this,c,e-this.la,f,b,a)}a=c}else a=this;return a};
...
l=me.prototype;l.yc=function(a){var b=Ja.apply(1,arguments),c=this.ob(b);c?c.push(new le(a)):this.mc(a,b)};
l.mc=function(a){this.ya.set(this.Ub(Ja.apply(1,arguments)),[new le(a)])};
l.ob=function(){var a=this.Ub(Ja.apply(0,arguments));return this.ya.has(a)?this.ya.get(a):void 0};
l.Lc=function(){var a=this.ob(Ja.apply(0,arguments));return a&&a.length?a[0]:void 0};
...
return a[$e]}
;function af(){J.call(this);this.m=new Ke(this);this.vc=this;this.ka=null}
...
l.Jc=function(){for(var a;a=Hf(this);)If(this,a,this.i,this.B);this.s=!1};
...
l.Fb=function(a){this.tc.apply(this,[a,1].concat(ha(Ja.apply(1,arguments))))};
...
for(var e=[],f=[],g=[],h=[128],k=1;64>k;++k)h[k]=0;var m,q;a();return{reset:a,update:c,digest:d,Fc:function(){for(var r=d(),x="",v=0;v<r.length;v++)x+="0123456789ABCDEF".charAt(Math.floor(r[v]/16))+"0123456789ABCDEF".charAt(r[v]%16);return x}}}
...
l.rb=function(){return pg(this).keys};
...
l=Jg.prototype;l.Dc=function(){this.dispose();mb(Mg,this)};
l.send=function(a,b,c,d){if(this.A)throw Error("[goog.net.XhrIo] Object is active with another request="+this.T+"; newUri="+a);b=b?b.toUpperCase():"GET";this.T=a;this.o="";this.P=!1;this.j=!0;this.A=this.K?Ig(this.K):Ig(Gg);this.J=this.K?this.K.getOptions():Gg.getOptions();this.A.onreadystatechange=Wa(this.cc,this);try{this.getStatus(),this.R=!0,this.A.open(b,String(a),!0),this.R=!1}catch(g){this.getStatus();Og(this,g);return}a=c||"";c=new Map(this.headers);if(d)if(Object.getPrototypeOf(d)===Object.prototype)for(var e in d)c.set(e,
...
e=y.FormData&&a instanceof y.FormData;!(0<=eb(Lg,b))||d||e||c.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");b=p(c);for(d=b.next();!d.done;d=b.next())c=p(d.value),d=c.next().value,c=c.next().value,this.A.setRequestHeader(d,c);this.da&&(this.A.responseType=this.da);"withCredentials"in this.A&&this.A.withCredentials!==this.X&&(this.A.withCredentials=this.X);try{Pg(this),0<this.s&&(this.W=Sg(this.A),this.getStatus(),this.W?(this.A.timeout=this.s,this.A.ontimeout=Wa(this.oc,this)):
this.G=Rf(this.oc,this.s,this)),this.getStatus(),this.v=!0,this.A.send(a),this.v=!1}catch(g){this.getStatus(),Og(this,g)}};
function Sg(a){return Mc&&Xc()&&"number"===typeof a.timeout&&void 0!==a.ontimeout}
l.oc=function(){"undefined"!=typeof Ma&&this.A&&(this.o="Timed out after "+this.s+"ms, aborting",this.getStatus(),bf(this,"timeout"),this.abort(8))};
...
l.cc=function(){this.i()||(this.R||this.v||this.l?Vg(this):this.Uc())};
l.Uc=function(){Vg(this)};
function Vg(a){if(a.j&&"undefined"!=typeof Ma)if(a.J[1]&&4==Wg(a)&&2==a.getStatus())a.getStatus();else if(a.v&&4==Wg(a))Rf(a.cc,0,a);else if(bf(a,"readystatechange"),a.isComplete()){a.getStatus();a.j=!1;try{if(Xg(a))bf(a,"complete"),bf(a,"success");else{try{var b=2<Wg(a)?a.A.statusText:""}catch(c){b=""}a.o=b+" ["+a.getStatus()+"]";Tg(a)}}finally{Ug(a)}}}
...
l.dispatch=function(a){if(a instanceof ch)this.log(a);else{var b=new ch;a=de(a);b=D(b,8,a);this.log(b)}};
function ph(a,b){a.s=new xg(1>b?1:b);Qf(a.j,a.s.getValue())}
l.log=function(a){a=a.clone();var b=this.wc++;D(a,21,b);this.P&&D(a,26,this.P);if(!Qd(a,1)){b=a;var c=Date.now().toString();D(b,1,c)}null!=Qd(a,15)||D(a,15,60*(new Date).getTimezoneOffset());this.o&&(b=this.o.clone(),G(a,vg,16,b));for(;1E3<=this.l.length;)this.l.shift(),++this.G;this.l.push(a);bf(this,new qh(a));this.W||this.j.enabled||this.j.start()};
l.flush=function(a,b){var c=this;if(0===this.l.length)a&&a();else if(this.X)rh(this);else{var d=Date.now();if(this.Jb>d&&this.da<d)b&&b("throttled");else{var e=sh(this.v,this.l,this.G);d={};var f=this.Qa();f&&(d.Authorization=f);var g=oh(this);this.K&&(d["X-Goog-AuthUser"]=this.K,g=wc(g,"authuser",this.K));this.pageId&&(d["X-Goog-PageId"]=this.pageId,g=wc(g,"pageId",this.pageId));if(f&&this.Ib===f)b&&b("stale-auth-token");else{this.l=[];this.j.enabled&&this.j.stop();this.G=0;var h=de(e),k;this.J&&
this.J.isSupported(h.length)&&(k=this.J.compress(h));var m={url:g,body:h,Bc:1,Ab:d,requestType:"POST",withCredentials:this.withCredentials,timeoutMillis:this.timeoutMillis},q=function(v){c.s.reset();Qf(c.j,c.s.getValue());if(v){var A=null;try{var E=JSON.parse(v.replace(")]}'\n",""));A=new gh(E)}catch(F){}A&&(v=Number(Sd(A,1,"-1")),0<v&&(c.da=Date.now(),c.Jb=c.da+v),A=jh.l(A))&&(A=Sd(A,1,-1),-1!=A&&(c.Pa||ph(c,A)))}a&&a()},r=function(v,A){var E=Yd(e,ch,3),F=c.s;
F.i=Math.min(3E5,2*F.i);F.j=Math.min(3E5,F.i+Math.round(.2*(Math.random()-.5)*F.i));Qf(c.j,c.s.getValue());401===v&&f&&(c.Ib=f);void 0===A&&(A=500<=v&&600>v||401===v||0===v);A&&(c.l=E.concat(c.l),c.W||c.j.enabled||c.j.start());b&&b("net-send-failed",v)},x=function(){c.Ea?c.Ea.send(m,q,r):c.uc(m,q,r)};
k?k.then(function(v){m.Ab["Content-Encoding"]="gzip";m.Ab["Content-Type"]="application/binary";m.body=v;m.Bc=2;x()},function(){x()}):x()}}}};
l.nb=function(){this.flush()};
function rh(a){th(a,function(b,c){b=wc(b,"format","json");b=window.navigator.sendBeacon(b,de(c));a.X&&!b&&(a.X=!1);return b})}
function th(a,b){if(0!==a.l.length){var c=Dc(oh(a),"format");c=uc(c,"auth",a.Qa(),"authuser",a.K||"0");for(var d=0;10>d&&a.l.length;++d){var e=a.l.slice(0,32),f=sh(a.v,e,a.G);if(!b(c,f))break;a.G=0;a.l=a.l.slice(e.length)}a.j.enabled&&a.j.stop()}}
...
;function wh(a,b,c){Ng(a.url,function(d){d=d.target;if(Xg(d)){try{var e=d.A?d.A.responseText:""}catch(f){e=""}b(e)}else c(d.getStatus())},a.requestType,a.body,a.Ab,a.timeoutMillis,a.withCredentials)}
;function xh(){this.l="https://play.google.com/log?format=json&hasfast=true";this.m=!1;this.s=wh;this.i=""}
;function yh(){var a=void 0===a?"":a;var b=void 0===b?!1:b;var c=void 0===c?"":c;var d=new xh;d.i="";""!=a&&(d.l=a);b&&(d.m=!0);c&&(d.j=c);a=new kh(1828,d.J?d.J:ug,"0",d.s,d.l,d.m,!1,d.R,void 0,void 0,d.B?d.B:void 0);d.v&&mh(a.v,d.v);d.j&&(b=d.j,c=uh(a.v),D(c,7,b));d.o&&(a.J=d.o);d.i&&(a.P=d.i);d.N&&((b=d.N)?(a.o||(a.o=new vg),b=de(b),D(a.o,4,b)):a.o&&D(a.o,4,void 0,!1));d.K&&(b=d.K,a.o||(a.o=new vg),Td(a.o,2,b));d.G&&(b=d.G,a.Pa=!0,ph(a,b));d.P&&vh(a.v,d.P);this.i=a}
yh.prototype.flush=function(a){a=a||[];if(a.length){for(var b=new gg,c=[],d=0;d<a.length;d++){var e=a[d],f=e;var g=new Zf;g=D(g,1,f.j);for(var h=f,k=[],m=0;m<h.i.length;m++)k.push(h.i[m].lb);g=Td(g,3,k);h=[];k=[];m=p(f.ya.keys());for(var q=m.next();!q.done;q=m.next())k.push(q.value.split(","));for(m=0;m<k.length;m++){q=k[m];var r=f.m;for(var x=f.ob(q)||[],v=[],A=0;A<x.length;A++){var E=x[A];E=E&&E.Nb;var F=new dg;switch(r){case 3:Ud(F,1,fg,Number(E));break;case 2:Ud(F,2,fg,Number(E))}v.push(F)}r=
v;for(x=0;x<r.length;x++){v=r[x];A=new ag;v=G(A,dg,2,v);A=q;E=[];F=f;for(var N=[],O=0;O<F.i.length;O++)N.push(F.i[O].mb);F=N;for(N=0;N<F.length;N++){O=F[N];var R=A[N],U=new cg;switch(O){case 3:Ud(U,1,eg,String(R));break;case 2:Ud(U,2,eg,Number(R));break;case 1:Ud(U,3,eg,"true"==R)}E.push(U)}$d(v,cg,1,E);h.push(v)}}$d(g,ag,4,h);c.push(g);e.clear()}$d(b,Zf,1,c);this.i.dispatch(b);this.i.flush()}};function zh(){this.o=Ah();this.s=new yh;this.i=new Sf(this.s);this.m=new Wf(this.i);this.j=new Xf(this.i);this.l=new Yf(this.i);this.Ba=window.document.location.hostname}
...
;function Ch(a){var b=this;this.Wa=!1;if(a.Nq){var c;this.ra=null!=(c=a.ra)?c:new zh}c=a.program;a=a.globalName;var d=new Bh;this.j=d.promise;this.pd=p((0,y[a].a)(c,function(e,f){Promise.resolve().then(function(){var g;if(null!=(g=b.ra)){var h=Ah()-g.o;g.m.i.hb("/client_streamz/bg/fil",h,g.Ba)}d.resolve({Ac:e,md:f})})},!0)).next().value;
this.ld=d.promise.then(function(){})}
Ch.prototype.snapshot=function(a){var b=this;if(this.Wa)throw Error("Already disposed");var c=Ah(),d;null!=(d=this.ra)&&d.j.i.Fb("/client_streamz/bg/fsc",d.Ba);return this.j.then(function(e){var f=e.Ac;return new Promise(function(g){f(function(h){var k;if(null!=(k=b.ra)){var m=Ah()-c;k.l.i.hb("/client_streamz/bg/fsl",m,k.Ba)}g(h)},[a.Pb,
a.nd])})})};
Ch.prototype.dispose=function(){var a;null!=(a=this.ra)&&a.i.ib();this.Wa=!0;this.j.then(function(b){(b=b.md)&&b()})};
...
l.forEach=function(a,b){for(var c=this.rb(),d=0;d<c.length;d++){var e=c[d],f=this.get(e);a.call(b,f,e,this)}};
...
t(Sj,I);
var Tj=[23,24,11,6,7,5,2,3,13,20,21,22,28,32,37,229,241,45,59,225,288,72,73,78,208,156,202,215,74,76,79,80,111,85,91,97,100,102,105,119,126,127,136,146,148,151,157,158,159,163,164,168,176,222,383,177,178,179,411,184,188,189,190,191,193,194,195,196,197,198,199,200,201,402,320,203,204,205,206,258,259,260,261,327,209,219,226,227,232,233,234,240,244,247,248,249,251,256,257,266,254,255,270,272,278,291,293,300,304,308,309,310,311,313,314,319,321,323,324,328,330,331,332,334,337,338,340,344,348,350,351,352,
353,354,355,356,357,358,361,363,364,368,369,370,373,374,375,378,380,381,388,389,403,410,412,429,413,414,415,416,417,418,430,423,424,425,426,427,431,117,439];var nk={Zi:0,Ki:1,Qi:2,Ri:4,Wi:8,Si:16,Ti:32,Yi:64,Xi:128,Mi:256,Oi:512,Vi:1024,Ni:2048,Pi:4096,Li:8192,Ui:16384};function ok(a){I.call(this,a)}
...
function Sl(a){var b=new $i,c=new Ti;D(c,1,a.Yb);D(c,2,a.Xb);D(c,16,a.Nc);D(c,17,a.innertubeContextClientVersion);if(a.tb){var d=a.tb,e=new Pi;d.coldConfigData&&D(e,1,d.coldConfigData);d.appInstallData&&D(e,6,d.appInstallData);d.coldHashData&&D(e,3,d.coldHashData);d.hotHashData&&D(e,5,d.hotHashData);G(c,Pi,62,e)}(d=y.devicePixelRatio)&&1!=d&&D(c,65,d);d=Hk();""!==d&&D(c,54,d);d=Ik();if(0<d.length){e=new Vi;for(var f=0;f<d.length;f++){var g=new Ni;D(g,1,d[f].key);g.setValue(d[f].value);ae(e,15,Ni,
...
function Ol(a,b,c){a=a.Wb;if("WEB"===a||"MWEB"===a||1===a||2===a)if(b){c=Wd(b,Qi,96)||new Qi;var d=vl();d=Object.keys(Zh).indexOf(d);d=-1===d?null:d;null!==d&&D(c,3,d);G(b,Qi,96,c)}else c&&(c.client.mainAppWebInfo=null!=(d=c.client.mainAppWebInfo)?d:{},c.client.mainAppWebInfo.webDisplayMode=vl())}
...
function Tl(a,b,c){c=void 0===c?{}:c;var d={};L("EOM_VISITOR_DATA")?d={"X-Goog-EOM-Visitor-Id":L("EOM_VISITOR_DATA")}:d={"X-Goog-Visitor-Id":c.visitorData||L("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.zq||L("AUTHORIZATION"))||(a?b="Bearer "+B("gapi.auth.getToken")().yq:b=ug([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=L("SESSION_INDEX",0),M("pageid_as_header_web")&&(d["X-Goog-PageId"]=L("DELEGATED_SESSION_ID")));return d}
...
a);
if("AbortError"===e.name)return new Fm("UNKNOWN_ABORT",a,e.message);e.args=[Object.assign({},a,{name:"IdbError",dc:e.name})];e.level="WARNING";return e}
...
var g=void 0!==b?self.indexedDB.open(a,b):self.indexedDB.open(a);var h=c.blocked,k=c.blocking,m=c.qd,q=c.upgrade,r=c.closed,x;g.addEventListener("upgradeneeded",function(v){try{if(null===v.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");if(null===g.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");v.dataLoss&&"none"!==v.dataLoss&&um("IDB_DATA_CORRUPTED",{reason:v.dataLossMessage||"unknown reason",dbName:ym(a)});var A=f(),E=new an(g.transaction);
...
function rn(a,b){if(!b)throw Km("openWithToken",ym(a.name));return a.open()}
pn.prototype.open=function(){function a(){var f,g,h,k,m,q,r,x,v,A;return w(function(E){switch(E.i){case 1:return g=null!=(f=Error().stack)?f:"",ya(E,2),u(E,c.l(c.name,c.options.version,e),4);case 4:h=E.j;for(var F=c.options,N=[],O=p(Object.keys(F.Ia)),R=O.next();!R.done;R=O.next()){R=R.value;var U=F.Ia[R],ca=void 0===U.Yc?Number.MAX_VALUE:U.Yc;!(h.i.version>=U.jb)||h.i.version>=ca||h.i.objectStoreNames.contains(R)||N.push(R)}k=N;if(0===k.length){E.u(5);break}m=Object.keys(c.options.Ia);q=h.objectStoreNames();
if(c.s<Gk("ytidb_reopen_db_retries",0))return c.s++,h.close(),tm(new Fm("DB_REOPENED_BY_MISSING_OBJECT_STORES",{dbName:c.name,expectedObjectStores:m,foundObjectStores:q})),E.return(a());if(!(c.o<Gk("ytidb_remake_db_retries",1))){E.u(6);break}c.o++;if(!M("ytidb_remake_db_enable_backoff_delay")){E.u(7);break}return u(E,on(c.j),8);case 8:c.j*=2;case 7:return u(E,c.delete(),9);case 9:return tm(new Fm("DB_DELETED_BY_MISSING_OBJECT_STORES",{dbName:c.name,expectedObjectStores:m,foundObjectStores:q})),E.return(a());
case 6:throw new Gm(q,m);case 5:return E.return(h);case 2:r=Aa(E);if(r instanceof DOMException?"VersionError"!==r.name:"DOMError"in self&&r instanceof DOMError?"VersionError"!==r.name:!(r instanceof Object&&"message"in r)||"An attempt was made to open a database using a lower version than the existing version."!==r.message){E.u(10);break}return u(E,c.l(c.name,void 0,Object.assign({},e,{upgrade:void 0})),11);case 11:x=E.j;v=x.i.version;if(void 0!==c.options.version&&v>c.options.version+1)throw x.close(),
c.m=!1,qn(c,v);return E.return(x);case 10:throw b(),r instanceof Error&&!M("ytidb_async_stack_killswitch")&&(r.stack=r.stack+"\n"+g.substring(g.indexOf("\n")+1)),Jm(r,c.name,"",null!=(A=c.options.version)?A:-1);}})}
function b(){c.i===d&&(c.i=void 0)}
var c=this;if(!this.m)throw qn(this);if(this.i)return this.i;var d,e={blocking:function(f){f.close()},
closed:b,qd:b,upgrade:this.options.upgrade};return this.i=d=a()};var sn=new pn("YtIdbMeta",{Ia:{databases:{jb:1}},upgrade:function(a,b){b(1)&&Ym(a,"databases",{keyPath:"actualName"})}});
function tn(a,b){var c;return w(function(d){if(1==d.i)return u(d,rn(sn,b),2);c=d.j;return d.return(Xm(c,["databases"],{U:!0,mode:"readwrite"},function(e){var f=e.objectStore("databases");return f.get(a.actualName).then(function(g){if(g?a.actualName!==g.actualName||a.publicName!==g.publicName||a.userIdentifier!==g.userIdentifier:1)return Um(f.i.put(a,void 0)).then(function(){})})}))})}
function un(a,b){var c;return w(function(d){if(1==d.i)return a?u(d,rn(sn,b),2):d.return();c=d.j;return d.return(c.delete("databases",a))})}
function vn(a,b){var c,d;return w(function(e){return 1==e.i?(c=[],u(e,rn(sn,b),2)):3!=e.i?(d=e.j,u(e,Xm(d,["databases"],{U:!0,mode:"readonly"},function(f){c.length=0;return fn(f.objectStore("databases"),{},function(g){a(g.getValue())&&c.push(g.getValue());return g.continue()})}),3)):e.return(c)})}
...
function yn(a){var b,c;return w(function(d){if(1==d.i)return b=wm("YtIdbMeta hasAnyMeta other"),u(d,vn(function(e){return void 0!==e.userIdentifier&&e.userIdentifier!==b},a),2);
...
ya(e,2);d={actualName:"yt-idb-test-do-not-use",publicName:"yt-idb-test-do-not-use",userIdentifier:void 0};return u(e,tn(d,An),4);case 4:return u(e,un("yt-idb-test-do-not-use",An),5);case 5:return e.return(!0);case 2:return Aa(e),e.return(!1)}})}
function Cn(){if(void 0!==zn)return zn;om=!0;return zn=Bn().then(function(a){om=!1;var b;if(null!=(b=km())&&b.i){var c;b={hasSucceededOnce:(null==(c=lm())?void 0:c.hasSucceededOnce)||a};var d;null==(d=km())||d.set("LAST_RESULT_ENTRY_KEY",b,2592E3,!0)}return a})}
...
;var Fn=0;function Gn(a,b){Fn||(Fn=Xh.S(function(){var c,d,e,f,g;return w(function(h){switch(h.i){case 1:return u(h,En(),2);case 2:c=h.j;if(!c)return h.return();d=!0;ya(h,3);return u(h,xn(a,c,b),5);case 5:e=h.j;if(!e.length){d=!1;h.u(6);break}f=e[0];return u(h,nn(f.actualName),7);case 7:return u(h,un(f.actualName,c),6);case 6:za(h,4);break;case 3:g=Aa(h),tm(g),d=!1;case 4:Xh.fa(Fn),Fn=0,d&&Gn(a,b),h.i=0}})}))}
function Hn(){var a;return w(function(b){return 1==b.i?u(b,En(),2):(a=b.j)?b.return(yn(a)):b.return(!1)})}
new Bh;function In(a){if(!vm())throw a=new Fm("AUTH_INVALID",{dbName:a}),tm(a),a;var b=wm();return{actualName:a+":"+b,publicName:a,userIdentifier:b}}
function Jn(a,b,c,d){var e,f,g,h,k,m;return w(function(q){switch(q.i){case 1:return f=null!=(e=Error().stack)?e:"",u(q,En(),2);case 2:g=q.j;if(!g)throw h=Km("openDbImpl",a,b),M("ytidb_async_stack_killswitch")||(h.stack=h.stack+"\n"+f.substring(f.indexOf("\n")+1)),tm(h),h;xm(a);k=c?{actualName:a,publicName:a,userIdentifier:void 0}:In(a);ya(q,3);return u(q,tn(k,g),5);case 5:return u(q,mn(k.actualName,b,d),6);case 6:return q.return(q.j);case 3:return m=Aa(q),ya(q,7),u(q,un(k.actualName,g),9);case 9:za(q,
...
function Mn(a,b){b=void 0===b?{}:b;var c,d;return w(function(e){if(1==e.i)return u(e,En(),2);if(3!=e.i){c=e.j;if(!c)return e.return();xm(a);d=In(a);return u(e,nn(d.actualName,b),3)}return u(e,un(d.actualName,c),0)})}
function Nn(a,b,c){a=a.map(function(d){return w(function(e){return 1==e.i?u(e,nn(d.actualName,b),2):u(e,un(d.actualName,c),0)})});
return Promise.all(a).then(function(){})}
function On(){var a=void 0===a?{}:a;var b,c;return w(function(d){if(1==d.i)return u(d,En(),2);if(3!=d.i){b=d.j;if(!b)return d.return();xm("LogsDatabaseV2");return u(d,wn(b),3)}c=d.j;return u(d,Nn(c,a,b),0)})}
function Pn(a,b){b=void 0===b?{}:b;var c;return w(function(d){if(1==d.i)return u(d,En(),2);if(3!=d.i){c=d.j;if(!c)return d.return();xm(a);return u(d,nn(a,b),3)}return u(d,un(a,c),0)})}
;function Qn(a){this.Sa=this.i=!1;this.potentialEsfErrorCounter=this.j=0;this.handleError=function(){};
this.Aa=function(){};
this.now=Date.now;this.Ga=!1;var b;this.nc=null!=(b=a.nc)?b:100;var c;this.jc=null!=(c=a.jc)?c:1;var d;this.hc=null!=(d=a.hc)?d:2592E6;var e;this.ec=null!=(e=a.ec)?e:12E4;var f;this.ic=null!=(f=a.ic)?f:5E3;var g;this.H=null!=(g=a.H)?g:void 0;this.Xa=!!a.Xa;var h;this.Va=null!=(h=a.Va)?h:.1;var k;this.cb=null!=(k=a.cb)?k:10;a.handleError&&(this.handleError=a.handleError);a.Aa&&(this.Aa=a.Aa);a.Ga&&(this.Ga=a.Ga);a.Sa&&(this.Sa=a.Sa);this.I=a.I;this.Z=a.Z;this.O=a.O;this.M=a.M;this.ia=a.ia;this.yb=
a.yb;this.xb=a.xb;Rn(this)&&(!this.I||this.I("networkless_logging"))&&Sn(this)}
function Sn(a){Rn(a)&&!a.Ga&&(a.i=!0,a.Xa&&Math.random()<=a.Va&&a.O.Cc(a.H),Tn(a),a.M.L()&&a.Ma(),a.M.aa(a.yb,a.Ma.bind(a)),a.M.aa(a.xb,a.Lb.bind(a)))}
...
b.onError=function(g,h){return w(function(k){if(1==k.i)return u(k,d.O.set(e,d.H).catch(function(m){Vn(d,m)}),2);
f(g,h);k.i=0})}}this.ia(a,b,e.skipRetry)}else this.O.set(e,this.H).catch(function(g){d.ia(a,b,e.skipRetry);
Vn(d,g)})}else this.ia(a,b,this.I&&this.I("nwl_skip_retry")&&c)};
...
l.Ma=function(){var a=this;if(!Rn(this))throw Km("throttleSend");this.j||(this.j=this.Z.S(function(){var b;return w(function(c){if(1==c.i)return u(c,a.O.Vb("NEW",a.H),2);if(3!=c.i)return b=c.j,b?u(c,Un(a,b),3):(a.Lb(),c.return());a.j&&(a.j=0,a.Ma());c.i=0})},this.nc))};
l.Lb=function(){this.Z.fa(this.j);this.j=0};
function Un(a,b){var c,d;return w(function(e){switch(e.i){case 1:if(!Rn(a))throw c=Km("immediateSend"),c;if(void 0===b.id){e.u(2);break}return u(e,a.O.Sc(b.id,a.H),3);case 3:(d=e.j)?b=d:a.Aa(Error("The request cannot be found in the database."));case 2:if(Wn(a,b,a.hc)){e.u(4);break}a.Aa(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===b.id){e.u(5);break}return u(e,a.O.za(b.id,a.H),5);case 5:return e.return();case 4:b.skipRetry||(b=Xn(a,b));if(!b){e.u(0);break}if(!b.skipRetry||
void 0===b.id){e.u(8);break}return u(e,a.O.za(b.id,a.H),8);case 8:a.ia(b.url,b.options,!!b.skipRetry),e.i=0}})}
function Xn(a,b){if(!Rn(a))throw Km("updateRequestHandlers");var c=b.options.onError?b.options.onError:function(){};
b.options.onError=function(e,f){var g,h,k;return w(function(m){switch(m.i){case 1:g=Yn(f);if(!(a.I&&a.I("nwl_consider_error_code")&&g||a.I&&!a.I("nwl_consider_error_code")&&a.potentialEsfErrorCounter<=a.cb)){m.u(2);break}if(!a.M.Ka){m.u(3);break}return u(m,a.M.Ka(),3);case 3:if(a.M.L()){m.u(2);break}c(e,f);if(!a.I||!a.I("nwl_consider_error_code")||void 0===(null==(h=b)?void 0:h.id)){m.u(6);break}return u(m,a.O.Bb(b.id,a.H,!1),6);case 6:return m.return();case 2:if(a.I&&a.I("nwl_consider_error_code")&&
!g&&a.potentialEsfErrorCounter>a.cb)return m.return();a.potentialEsfErrorCounter++;if(void 0===(null==(k=b)?void 0:k.id)){m.u(8);break}return b.sendCount<a.jc?u(m,a.O.Bb(b.id,a.H),12):u(m,a.O.za(b.id,a.H),8);case 12:a.Z.S(function(){a.M.L()&&a.Ma()},a.ic);
case 8:c(e,f),m.i=0}})};
...
function Tn(a){if(!Rn(a))throw Km("retryQueuedRequests");a.O.Vb("QUEUED",a.H).then(function(b){b&&!Wn(a,b,a.ec)?a.Z.S(function(){return w(function(c){if(1==c.i)return void 0===b.id?c.u(2):u(c,a.O.Bb(b.id,a.H),2);Tn(a);c.i=0})}):a.M.L()&&a.Ma()})}
function Vn(a,b){a.sc&&!a.M.L()?a.sc(b):a.handleError(b)}
function Rn(a){return!!a.H||a.Sa}
...
;function mo(a,b){pn.call(this,a,b);this.options=b;xm(a)}
t(mo,pn);function no(a,b){var c;return function(){c||(c=new mo(a,b));return c}}
mo.prototype.l=function(a,b,c){c=void 0===c?{}:c;return(this.options.Db?Ln:Kn)(a,b,Object.assign({},c))};
mo.prototype.delete=function(a){a=void 0===a?{}:a;return(this.options.Db?Pn:Mn)(this.name,a)};
function oo(a,b){return no(a,b)}
;var po;
function qo(){if(po)return po();var a={};po=oo("LogsDatabaseV2",{Ia:(a.LogsRequestsStore={jb:2},a),Db:!1,upgrade:function(b,c,d){c(2)&&Ym(b,"LogsRequestsStore",{keyPath:"id",autoIncrement:!0});c(3);c(5)&&(d=d.objectStore("LogsRequestsStore"),d.i.indexNames.contains("newRequest")&&d.i.deleteIndex("newRequest"),d.i.createIndex("newRequestV2",["status","interface","timestamp"],{unique:!1}));c(7)&&b.i.objectStoreNames.contains("sapisid")&&b.i.deleteObjectStore("sapisid");c(9)&&b.i.objectStoreNames.contains("SWHealthLog")&&b.i.deleteObjectStore("SWHealthLog")},
version:9});return po()}
;function ro(a){return rn(qo(),a)}
function so(a,b){var c,d,e,f;return w(function(g){if(1==g.i)return c={startTime:P(),transactionType:"YT_IDB_TRANSACTION_TYPE_WRITE"},u(g,ro(b),2);if(3!=g.i)return d=g.j,e=Object.assign({},a,{options:JSON.parse(JSON.stringify(a.options)),interface:L("INNERTUBE_CONTEXT_CLIENT_NAME",0)}),u(g,$m(d,e),3);f=g.j;c.sd=P();to(c);return g.return(f)})}
function uo(a,b){var c,d,e,f,g,h,k;return w(function(m){if(1==m.i)return c={startTime:P(),transactionType:"YT_IDB_TRANSACTION_TYPE_READ"},u(m,ro(b),2);if(3!=m.i)return d=m.j,e=L("INNERTUBE_CONTEXT_CLIENT_NAME",0),f=[a,e,0],g=[a,e,P()],h=IDBKeyRange.bound(f,g),k=void 0,u(m,Xm(d,["LogsRequestsStore"],{mode:"readwrite",U:!0},function(q){return jn(q.objectStore("LogsRequestsStore").index("newRequestV2"),{query:h,direction:"prev"},function(r){r.getValue()&&(k=r.getValue(),"NEW"===a&&(k.status="QUEUED",
r.update(k)))})}),3);
c.sd=P();to(c);return m.return(k)})}
function vo(a,b){var c;return w(function(d){if(1==d.i)return u(d,ro(b),2);c=d.j;return d.return(Xm(c,["LogsRequestsStore"],{mode:"readwrite",U:!0},function(e){var f=e.objectStore("LogsRequestsStore");return f.get(a).then(function(g){if(g)return g.status="QUEUED",Um(f.i.put(g,void 0)).then(function(){return g})})}))})}
function wo(a,b,c){c=void 0===c?!0:c;var d;return w(function(e){if(1==e.i)return u(e,ro(b),2);d=e.j;return e.return(Xm(d,["LogsRequestsStore"],{mode:"readwrite",U:!0},function(f){var g=f.objectStore("LogsRequestsStore");return g.get(a).then(function(h){return h?(h.status="NEW",c&&(h.sendCount+=1),Um(g.i.put(h,void 0)).then(function(){return h})):Om.resolve(void 0)})}))})}
function xo(a,b){var c;return w(function(d){if(1==d.i)return u(d,ro(b),2);c=d.j;return d.return(c.delete("LogsRequestsStore",a))})}
function yo(a){var b,c;return w(function(d){if(1==d.i)return u(d,ro(a),2);b=d.j;c=P()-2592E6;return u(d,Xm(b,["LogsRequestsStore"],{mode:"readwrite",U:!0},function(e){return fn(e.objectStore("LogsRequestsStore"),{},function(f){if(f.getValue().timestamp<=c)return f.delete().then(function(){return f.continue()})})}),0)})}
function zo(){return w(function(a){return u(a,On(),0)})}
function to(a){M("nwl_csi_killswitch")||.01>=Math.random()&&fo("nwl_transaction_latency_payload",a)}
;var Ao={},Bo=oo("ServiceWorkerLogsDatabase",{Ia:(Ao.SWHealthLog={jb:1},Ao),Db:!0,upgrade:function(a,b){b(1)&&Ym(a,"SWHealthLog",{keyPath:"id",autoIncrement:!0}).i.createIndex("swHealthNewRequest",["interface","timestamp"],{unique:!1})},
version:1});function Co(a){return rn(Bo(),a)}
function Do(a){var b,c;return w(function(d){if(1==d.i)return u(d,Co(a),2);b=d.j;c=P()-2592E6;return u(d,Xm(b,["SWHealthLog"],{mode:"readwrite",U:!0},function(e){return fn(e.objectStore("SWHealthLog"),{},function(f){if(f.getValue().timestamp<=c)return f.delete().then(function(){return f.continue()})})}),0)})}
function Eo(a){var b;return w(function(c){if(1==c.i)return u(c,Co(a),2);b=c.j;return u(c,b.clear("SWHealthLog"),0)})}
;var Fo={},Go=0;
function Ho(a){var b=void 0===b?"":b;var c=void 0===c?!1:c;if(a)if(b)pl(a,void 0,"POST",b);else if(L("USE_NET_AJAX_FOR_PING_TRANSPORT",!1))pl(a,void 0,"GET","",void 0,void 0,c);else{b:{try{var d=new bb({url:a});if(d.l&&d.j||d.m){var e=mc(nc(5,a)),f;if(!(f=!e||!e.endsWith("/aclk"))){var g=a.search(Bc),h=Ac(a,0,"ri",g);if(0>h)var k=null;else{var m=a.indexOf("&",h);if(0>m||m>g)m=g;k=decodeURIComponent(a.slice(h+3,-1!==m?m:0).replace(/\+/g," "))}f="1"!==k}var q=!f;break b}}catch(x){}q=!1}if(q){b:{try{if(window.navigator&&
...
Jo.prototype.removeParams=Jo.prototype.removeParams;Jo.prototype.isEndpointCFR=Jo.prototype.isEndpointCFR;Jo.prototype.requestComplete=Jo.prototype.requestComplete;Jo.getInstance=Ko;var Lo;function Mo(){Lo||(Lo=new Vl("yt.offline"));return Lo}
...
;function Oo(){af.call(this);var a=this;this.l=!1;this.j=Wh();this.j.aa("networkstatus-online",function(){if(a.l&&M("offline_error_handling")){var b=Mo().get("errors",!0);if(b){for(var c in b)if(b[c]){var d=new Q(c,"sent via offline_errors");d.name=b[c].name;d.stack=b[c].stack;d.level=b[c].level;Mk(d)}Mo().set("errors",{},2592E3,!0)}}})}
...
return a};
Oo.prototype.sendNetworkCheckRequest=Oo.prototype.Ka;Oo.prototype.listen=Oo.prototype.aa;Oo.prototype.enableErrorFlushing=Oo.prototype.Gc;Oo.prototype.getWindowStatus=Oo.prototype.Mc;Oo.prototype.networkStatusHint=Oo.prototype.ha;Oo.prototype.isNetworkAvailable=Oo.prototype.L;Oo.getInstance=Po;function Qo(a){a=void 0===a?{}:a;af.call(this);var b=this;this.j=this.s=0;this.l=Po();var c=B("yt.networkStatusManager.instance.listen").bind(this.l);c&&(a.fb?(this.fb=a.fb,c("networkstatus-online",function(){Ro(b,"publicytnetworkstatus-online")}),c("networkstatus-offline",function(){Ro(b,"publicytnetworkstatus-offline")})):(c("networkstatus-online",function(){bf(b,"publicytnetworkstatus-online")}),c("networkstatus-offline",function(){bf(b,"publicytnetworkstatus-offline")})))}
t(Qo,af);Qo.prototype.L=function(){var a=B("yt.networkStatusManager.instance.isNetworkAvailable");return a?a.bind(this.l)():!0};
...
function Ro(a,b){a.fb?a.j?(Xh.fa(a.s),a.s=Xh.S(function(){a.o!==b&&(bf(a,b),a.o=b,a.j=P())},a.fb-(P()-a.j))):(bf(a,b),a.o=b,a.j=P()):bf(a,b)}
;var So;function To(){Qn.call(this,{O:{Cc:yo,za:xo,Vb:uo,Sc:vo,Bb:wo,set:so},M:Uo(),handleError:Mk,Aa:Nk,ia:Vo,now:P,sc:No,Z:hm(),yb:"publicytnetworkstatus-online",xb:"publicytnetworkstatus-offline",Xa:!0,Va:.1,cb:Gk("potential_esf_error_limit",10),I:M,Ga:!(vm()&&Wo())});this.l=new Bh;M("networkless_immediately_drop_all_requests")&&zo();Pn("LogsDatabaseV2")}
t(To,Qn);function Xo(){var a=B("yt.networklessRequestController.instance");a||(a=new To,z("yt.networklessRequestController.instance",a),M("networkless_logging")&&En().then(function(b){a.H=b;Sn(a);a.l.resolve();a.Xa&&Math.random()<=a.Va&&a.H&&Do(a.H);M("networkless_immediately_drop_sw_health_store")&&Yo(a)}));
return a}
To.prototype.writeThenSend=function(a,b){b||(b={});vm()||(this.i=!1);Qn.prototype.writeThenSend.call(this,a,b)};
To.prototype.sendThenWrite=function(a,b,c){b||(b={});vm()||(this.i=!1);Qn.prototype.sendThenWrite.call(this,a,b,c)};
To.prototype.sendAndWrite=function(a,b){b||(b={});vm()||(this.i=!1);Qn.prototype.sendAndWrite.call(this,a,b)};
To.prototype.awaitInitialization=function(){return this.l.promise};
function Yo(a){var b;w(function(c){if(!a.H)throw b=Km("clearSWHealthLogsDb"),b;return c.return(Eo(a.H).catch(function(d){a.handleError(d)}))})}
function Vo(a,b,c){M("use_cfr_monitor")&&Zo(a,b);if(M("use_request_time_ms_header"))b.headers&&(b.headers["X-Goog-Request-Time"]=JSON.stringify(Math.round(P())));else{var d;if(null==(d=b.postParams)?0:d.requestTimeMs)b.postParams.requestTimeMs=Math.round(P())}c&&0===Object.keys(b).length?Ho(a):ml(a,b)}
function Uo(){So||(So=new Qo({Rc:!0,Hc:!0}));return So}
...
function ep(){var a;w(function(b){switch(b.i){case 1:return u(b,En(),2);case 2:a=b.j;if(!a||!vm()&&!M("nwl_init_require_datasync_id_killswitch")||!Wo()){b.u(0);break}$o=!0;dp.isNwlInitialized=$o;if(!M("use_new_nwl_initialization")){b.u(4);break}return u(b,Xo().awaitInitialization(),5);case 5:return b.return();case 4:return u(b,Pn("LogsDatabaseV2"),6);case 6:if(!(.1>=Math.random())){b.u(7);break}return u(b,yo(a),8);case 8:return u(b,Do(a),7);case 7:fp();gp().L()&&hp();gp().aa("publicytnetworkstatus-online",
hp);gp().aa("publicytnetworkstatus-offline",ip);if(!M("networkless_immediately_drop_sw_health_store")){b.u(10);break}return u(b,jp(),10);case 10:if(M("networkless_immediately_drop_all_requests"))return u(b,zo(),0);b.u(0)}})}
...
so(e,d).then(function(k){e.id=k;f&&xo(e.id,d)}).catch(function(k){gp().L()?Mk(k):No(k)})}else mp(a,b)}
b=void 0===b?{}:b;M("skip_is_supported_killswitch")?En().then(function(d){c(d)}):c(Dn())}
function hp(){var a=Dn();if(!a)throw Km("throttleSend");ap||(ap=Xh.S(function(){var b;return w(function(c){if(1==c.i)return u(c,uo("NEW",a),2);if(3!=c.i)return b=c.j,b?u(c,np(b),3):(ip(),c.return());ap&&(ap=0,hp());c.i=0})},100))}
function ip(){Xh.fa(ap);ap=0}
function np(a){var b,c,d;return w(function(e){switch(e.i){case 1:b=Dn();if(!b)throw c=Km("immediateSend"),c;if(void 0===a.id){e.u(2);break}return u(e,vo(a.id,b),3);case 3:(d=e.j)?a=d:Nk(Error("The request cannot be found in the database."));case 2:if(pp(a,2592E6)){e.u(4);break}Nk(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===a.id){e.u(5);break}return u(e,xo(a.id,b),5);case 5:return e.return();case 4:a.skipRetry||(a=qp(a));var f=a;if(M("use_request_time_ms_header")){var g;
if(null==f?0:null==(g=f.options)?0:g.headers)f.options.headers["X-Goog-Request-Time"]=JSON.stringify(Math.round(P()))}else{var h,k;if(null==f?0:null==(h=f.options)?0:null==(k=h.postParams)?0:k.requestTimeMs)f.options.postParams.requestTimeMs=Math.round(P())}a=f;if(!a){e.u(0);break}if(!a.skipRetry||void 0===a.id){e.u(8);break}return u(e,xo(a.id,b),8);case 8:mp(a.url,a.options,!!a.skipRetry),e.i=0}})}
function qp(a){var b=Dn();if(!b)throw Km("updateRequestHandlers");var c=a.options.onError?a.options.onError:function(){};
a.options.onError=function(e,f){var g,h,k;return w(function(m){switch(m.i){case 1:M("use_cfr_monitor")&&Ko().requestComplete(a.url,!1);g=Yn(f);if(!(M("nwl_consider_error_code")&&g||!M("nwl_consider_error_code")&&Dp()<=Gk("potential_esf_error_limit",10))){m.u(2);break}if(M("skip_checking_network_on_cfr_failure")&&(!M("skip_checking_network_on_cfr_failure")||Ko().isEndpointCFR(a.url))){m.u(3);break}return u(m,gp().Ka(),3);case 3:if(gp().L()){m.u(2);break}c(e,f);if(!M("nwl_consider_error_code")||void 0===
(null==(h=a)?void 0:h.id)){m.u(6);break}return u(m,wo(a.id,b,!1),6);case 6:return m.return();case 2:if(M("nwl_consider_error_code")&&!g&&Dp()>Gk("potential_esf_error_limit",10))return m.return();B("ytNetworklessLoggingInitializationOptions")&&dp.potentialEsfErrorCounter++;bp++;if(void 0===(null==(k=a)?void 0:k.id)){m.u(8);break}return 1>a.sendCount?u(m,wo(a.id,b),12):u(m,xo(a.id,b),8);case 12:Xh.S(function(){gp().L()&&hp()},5E3);
case 8:c(e,f),m.i=0}})};
var d=a.options.onSuccess?a.options.onSuccess:function(){};
a.options.onSuccess=function(e,f){var g;return w(function(h){if(1==h.i)return M("use_cfr_monitor")&&Ko().requestComplete(a.url,!0),void 0===(null==(g=a)?void 0:g.id)?h.u(2):u(h,xo(a.id,b),2);M("vss_network_hint")&&gp().ha(!0);d(e,f);h.i=0})};
return a}
function pp(a,b){a=a.timestamp;return P()-a>=b?!1:!0}
function fp(){var a=Dn();if(!a)throw Km("retryQueuedRequests");uo("QUEUED",a).then(function(b){b&&!pp(b,12E4)?Xh.S(function(){return w(function(c){if(1==c.i)return void 0===b.id?c.u(2):u(c,wo(b.id,a),2);fp();c.i=0})}):gp().L()&&hp()})}
function jp(){var a,b;return w(function(c){a=Dn();if(!a)throw b=Km("clearSWHealthLogsDb"),b;return c.return(Eo(a).catch(function(d){Mk(d)}))})}
function gp(){if(M("use_new_nwl"))return Uo();cp||(cp=new Qo({Rc:!0,Hc:!0}));return cp}
function mp(a,b,c){c&&0===Object.keys(b).length?Ho(a):ml(a,b)}
function lp(){return B("ytNetworklessLoggingInitializationOptions")?dp.isNwlInitialized:$o}
function Dp(){return B("ytNetworklessLoggingInitializationOptions")?dp.potentialEsfErrorCounter:bp}
;function bq(a){var b=this;this.config_=null;a?this.config_=a:Ll()&&(this.config_=Ml());dm(function(){am(b)},0,5E3)}
bq.prototype.isReady=function(){!this.config_&&Ll()&&(this.config_=Ml());return!!this.config_};
...
c.onFetchSuccess=function(O,R){$l(E);N(O,R)}}try{A&&d.retry&&!d.ac.bypassNetworkless?(g.method="POST",d.ac.writeThenSend?M("use_new_nwl_wts")?Xo().writeThenSend(v,g):kp(v,g):M("use_new_nwl_saw")?Xo().sendAndWrite(v,g):op(v,g)):(g.method="POST",g.postParams||(g.postParams={}),ml(v,g))}catch(O){if("InvalidAccessError"==O.name)E&&($l(E),E=0),Nk(Error("An extension is blocking network request."));
...
function kq(a,b,c,d){d=void 0===d?{}:d;if(!a||!a.addEventListener&&!a.attachEvent)return"";var e=iq(a,b,c,d);if(e)return e;e=++hq.count+"";var f=!("mouseenter"!=b&&"mouseleave"!=b||!a.addEventListener||"onmouseenter"in document);var g=f?function(h){h=new fq(h);if(!lf(h.relatedTarget,function(k){return k==a}))return h.currentTarget=a,h.type=b,c.call(a,h)}:function(h){h=new fq(h);
h.currentTarget=a;return c.call(a,h)};
g=Lk(g);a.addEventListener?("mouseenter"==b&&f?b="mouseover":"mouseleave"==b&&f?b="mouseout":"mousewheel"==b&&"MozBoxSizing"in document.documentElement.style&&(b="MozMousePixelScroll"),jq()||"boolean"===typeof d?a.addEventListener(b,g,d):a.addEventListener(b,g,!!d.capture)):a.attachEvent("on"+b,g);qb[e]=[a,b,c,g,d];return e}
...
;var mq=window.ytcsi&&window.ytcsi.now?window.ytcsi.now:window.performance&&window.performance.timing&&window.performance.now&&window.performance.timing.navigationStart?function(){return window.performance.timing.navigationStart+window.performance.now()}:function(){return(new Date).getTime()};function nq(a){this.G=a;this.j=null;this.o=0;this.v=null;this.s=0;this.l=[];for(a=0;4>a;a++)this.l.push(0);this.m=0;this.K=kq(window,"mousemove",Wa(this.P,this));a=Wa(this.J,this);"function"===typeof a&&(a=Lk(a));this.R=window.setInterval(a,25)}
Za(nq,J);nq.prototype.P=function(a){void 0===a.i&&gq(a);var b=a.i;void 0===a.j&&gq(a);this.j=new gf(b,a.j)};
nq.prototype.J=function(){if(this.j){var a=mq();if(0!=this.o){var b=this.v,c=this.j,d=b.x-c.x;b=b.y-c.y;d=Math.sqrt(d*d+b*b)/(a-this.o);this.l[this.m]=.5<Math.abs((d-this.s)/this.s)?1:0;for(c=b=0;4>c;c++)b+=this.l[c]||0;3<=b&&this.G();this.s=d}this.o=a;this.v=this.j;this.m=(this.m+1)%4}};
nq.prototype.D=function(){window.clearInterval(this.R);lq(this.K)};var oq={};
function pq(a){var b=void 0===a?{}:a;a=void 0===b.Wc?!1:b.Wc;b=void 0===b.Ic?!0:b.Ic;if(null==B("_lact",window)){var c=parseInt(L("LACT"),10);c=isFinite(c)?Date.now()-Math.max(c,0):-1;z("_lact",c,window);z("_fact",c,window);-1==c&&qq();kq(document,"keydown",qq);kq(document,"keyup",qq);kq(document,"mousedown",qq);kq(document,"mouseup",qq);a?kq(window,"touchmove",function(){rq("touchmove",200)},{passive:!0}):(kq(window,"resize",function(){rq("resize",200)}),b&&kq(window,"scroll",function(){rq("scroll",200)}));
new nq(function(){rq("mouse",100)});
kq(document,"touchstart",qq,{passive:!0});kq(document,"touchend",qq,{passive:!0})}}
function rq(a,b){oq[a]||(oq[a]=!0,Xh.S(function(){qq();oq[a]=!1},b))}
...
try{wq[a]?f():fl(f,0)}catch(g){Mk(g)}},void 0);
...
K.prototype.subscribe=K.prototype.subscribe;K.prototype.unsubscribeByKey=K.prototype.Da;K.prototype.publish=K.prototype.qa;K.prototype.clear=K.prototype.clear;z("ytPubsubPubsubInstance",tq);z("ytPubsubPubsubTopicToKeys",vq);z("ytPubsubPubsubIsSynchronous",wq);z("ytPubsubPubsubSubscribedKeys",uq);function Dq(a){this.policy=a;this.store=[];this.i={}}
Dq.prototype.storePayload=function(a,b){this.store.push({payload:b,keys:a});b=[void 0===a.auth?"undefined":a.auth,void 0===a.isJspb?"undefined":a.isJspb,void 0===a.cttAuthInfo?"undefined":a.cttAuthInfo].join("/");this.i[b]?this.i[b]++:this.i[b]=1;this.i[b]>=this.policy.maxBatchSize&&(this.policy.onBatchSizeExceeded(a),this.i[b]=0);return b};
Dq.prototype.extractMatchingEntries=function(a){for(var b=[],c=[],d=p(this.store),e=d.next();!e.done;e=d.next()){e=e.value;a:{var f=a;var g=Object.keys(f);g=p(g);for(var h=g.next();!h.done;h=g.next())if(h=h.value,e.keys[h]!==f[h]){f=!1;break a}f=!0}f?b.push(e.payload):c.push(e)}this.store=c;c=0;a=Eq(this,a);a=p(a);for(d=a.next();!d.done;d=a.next())d=d.value,c+=this.i[d],this.i[d]=0;c!==b.length&&Nk(new Q("Transport IMS extracted entries count != keyCounter sum",b.length,c));return b};
Dq.prototype.getSequenceCount=function(a){var b=Eq(this,a);a=0;b=p(b);for(var c=b.next();!c.done;c=b.next())a+=this.i[c.value];return a};
function Eq(a,b){var c=Object.keys(b),d="THIS_KEY_FIELD_NOT_FILLED",e="THIS_KEY_FIELD_NOT_FILLED",f="THIS_KEY_FIELD_NOT_FILLED";c=p(c);for(var g=c.next();!g.done;g=c.next())g=g.value,"auth"===g?d=Fq(b.auth):"isJspb"===g?e=JSON.stringify(b.isJspb):"cttAuthInfo"===g&&(f=Fq(b.cttAuthInfo));b=[];d=[d,e,f];a=p(Object.keys(a.i));for(e=a.next();!e.done;e=a.next()){e=e.value;f=e.split("/");c=!0;for(g=0;g<d.length;g++)if("THIS_KEY_FIELD_NOT_FILLED"!==d[g]&&d[g]!==f[g]){c=!1;break}c&&b.push(e)}return b}
Dq.prototype.getSequenceCount=Dq.prototype.getSequenceCount;Dq.prototype.extractMatchingEntries=Dq.prototype.extractMatchingEntries;Dq.prototype.storePayload=Dq.prototype.storePayload;function Fq(a){return void 0===a?"undefined":a}
;var Gq=Gk("initial_gel_batch_timeout",2E3),Hq=Math.pow(2,16)-1,Iq=void 0;function Jq(){this.l=this.i=this.j=0}
var Kq=new Jq,Lq=new Jq,Mq=!0,Nq=y.ytLoggingTransportGELQueue_||new Map;z("ytLoggingTransportGELQueue_",Nq);var Oq=y.ytLoggingTransportGELProtoQueue_||new Map;z("ytLoggingTransportGELProtoQueue_",Oq);var Pq=y.ytLoggingTransportTokensToCttTargetIds_||{};z("ytLoggingTransportTokensToCttTargetIds_",Pq);var Qq=y.ytLoggingTransportTokensToJspbCttTargetIds_||{};z("ytLoggingTransportTokensToJspbCttTargetIds_",Qq);var Rq={};
function Sq(){var a=B("yt.logging.ims");a||(a=new Dq({maxBatchSize:Gk("tvhtml5_logging_max_batch")||Gk("web_logging_max_batch")||100,onBatchSizeExceeded:function(b){Tq({writeThenSend:!0},void 0,b.isJspb)}}),z("yt.logging.ims",a));
return a}
function Uq(a,b){if("log_event"===a.endpoint){Vq(a);var c=Wq(a);if(M("use_new_in_memory_storage")){Rq[c]=!0;var d={cttAuthInfo:c,isJspb:!1};Sq().storePayload(d,a.payload);Xq(b,[],c,!1,d)}else d=Nq.get(c)||[],Nq.set(c,d),d.push(a.payload),Xq(b,d,c)}}
function Yq(a,b){if("log_event"===a.endpoint){Vq(void 0,a);var c=Wq(a,!0);if(M("use_new_in_memory_storage")){Rq[c]=!0;var d={cttAuthInfo:c,isJspb:!0};Sq().storePayload(d,a.payload.toJSON());Xq(b,[],c,!0,d)}else d=Oq.get(c)||[],Oq.set(c,d),a=a.payload.toJSON(),d.push(a),Xq(b,d,c,!0)}}
function Xq(a,b,c,d,e){d=void 0===d?!1:d;a&&(Iq=new a);a=Gk("tvhtml5_logging_max_batch")||Gk("web_logging_max_batch")||100;var f=P(),g=d?Lq.l:Kq.l;b=b.length;e&&(b=Sq().getSequenceCount(e));b>=a?Tq({writeThenSend:!0},M("flush_only_full_queue")?c:void 0,d):10<=f-g&&(Zq(d),d?Lq.l=f:Kq.l=f)}
function $q(a,b){if("log_event"===a.endpoint){Vq(a);var c=Wq(a),d=new Map;d.set(c,[a.payload]);b&&(Iq=new b);return new yf(function(e,f){Iq&&Iq.isReady()?ar(d,Iq,e,f,{bypassNetworkless:!0},!0):e()})}}
function br(a,b){if("log_event"===a.endpoint){Vq(void 0,a);var c=Wq(a,!0),d=new Map;d.set(c,[a.payload.toJSON()]);b&&(Iq=new b);return new yf(function(e){Iq&&Iq.isReady()?cr(d,Iq,e,{bypassNetworkless:!0},!0):e()})}}
function Wq(a,b){var c="";if(a.Fa)c="visitorOnlyApprovedKey";else if(a.cttAuthInfo){if(void 0===b?0:b){b=a.cttAuthInfo.token;c=a.cttAuthInfo;var d=new pk;c.videoId?d.setVideoId(c.videoId):c.playlistId&&Ud(d,2,qk,c.playlistId);Qq[b]=d}else b=a.cttAuthInfo,c={},b.videoId?c.videoId=b.videoId:b.playlistId&&(c.playlistId=b.playlistId),Pq[a.cttAuthInfo.token]=c;c=a.cttAuthInfo.token}return c}
function Tq(a,b,c){a=void 0===a?{}:a;c=void 0===c?!1:c;new yf(function(d,e){c?(gl(Lq.j),gl(Lq.i),Lq.i=0):(gl(Kq.j),gl(Kq.i),Kq.i=0);if(Iq&&Iq.isReady())if(M("use_new_in_memory_storage")){var f=a,g=c,h=Iq;f=void 0===f?{}:f;g=void 0===g?!1:g;var k=new Map,m=new Map;if(void 0!==b)g?(e=Sq().extractMatchingEntries({isJspb:g,cttAuthInfo:b}),k.set(b,e),cr(k,h,d,f)):(k=Sq().extractMatchingEntries({isJspb:g,cttAuthInfo:b}),m.set(b,k),ar(m,h,d,e,f));else if(g){e=p(Object.keys(Rq));for(g=e.next();!g.done;g=
e.next())m=g.value,g=Sq().extractMatchingEntries({isJspb:!0,cttAuthInfo:m}),0<g.length&&k.set(m,g),Rq[m]=!1;cr(k,h,d,f)}else{k=p(Object.keys(Rq));for(g=k.next();!g.done;g=k.next()){g=g.value;var q=Sq().extractMatchingEntries({isJspb:!1,cttAuthInfo:g});0!==q.length&&m.set(g,q)}ar(m,h,d,e,f)}}else f=a,k=c,h=Iq,f=void 0===f?{}:f,k=void 0===k?!1:k,void 0!==b?k?(e=new Map,k=Oq.get(b)||[],e.set(b,k),cr(e,h,d,f),Oq.delete(b)):(k=new Map,m=Nq.get(b)||[],k.set(b,m),ar(k,h,d,e,f),Nq.delete(b)):k?(cr(Oq,h,d,
f),Oq.clear()):(ar(Nq,h,d,e,f),Nq.clear());else Zq(c),d()})}
function Zq(a){a=void 0===a?!1:a;if(M("web_gel_timeout_cap")&&(!a&&!Kq.i||a&&!Lq.i)){var b=fl(function(){Tq({writeThenSend:!0},void 0,a)},6E4);
a?Lq.i=b:Kq.i=b}gl(a?Lq.j:Kq.j);b=L("LOGGING_BATCH_TIMEOUT",Gk("web_gel_debounce_ms",1E4));M("shorten_initial_gel_batch_timeout")&&Mq&&(b=Gq);b=fl(function(){Tq({writeThenSend:!0},void 0,a)},b);
a?Lq.j=b:Kq.j=b}
function ar(a,b,c,d,e,f){e=void 0===e?{}:e;var g=Math.round(P()),h=a.size;a=p(a);for(var k=a.next();!k.done;k=a.next()){var m=p(k.value);k=m.next().value;var q=m.next().value;m=k;k=wb({context:Nl(b.config_||Ml())});if(!Pa(q)&&!M("throw_err_when_logevent_malformed_killswitch")){d();break}k.events=q;(q=Pq[m])&&dr(k,m,q);delete Pq[m];m="visitorOnlyApprovedKey"===m;er(k,g,m);fr(e);q=function(){h--;h||c()};
var r=function(){h--;h||c()};
try{bm(b,"log_event",k,gr(e,m,q,r,f)),Mq=!1}catch(x){Mk(x),d()}}}
function cr(a,b,c,d,e){d=void 0===d?{}:d;var f=Math.round(P()),g=a.size,h=new Map([].concat(ha(a)));h=p(h);for(var k=h.next();!k.done;k=h.next()){var m=p(k.value).next().value,q=a.get(m);k=new rk;var r=Sl(b.config_||Ml());G(k,$i,1,r);q=q?hr(q):[];q=p(q);for(r=q.next();!r.done;r=q.next())ae(k,3,Sj,r.value);(q=Qq[m])&&ir(k,m,q);delete Qq[m];m="visitorOnlyApprovedKey"===m;jr(k,f,m);fr(d);k=de(k);m=gr(d,m,function(){g--;g||c()},function(){g--;
g||c()},e);
m.headers["Content-Type"]="application/json+protobuf";m.postBodyFormat="JSPB";m.postBody=k;bm(b,"log_event","",m);Mq=!1}}
function fr(a){M("always_send_and_write")&&(a.writeThenSend=!1)}
function gr(a,b,c,d,e){a={retry:!0,onSuccess:c,onError:d,ac:a,Fa:b,Bq:!!e,headers:{},postBodyFormat:"",postBody:""};M("use_request_time_ms_header")&&(a.headers["X-Goog-Request-Time"]=JSON.stringify(Math.round(P())));return a}
function er(a,b,c){M("use_request_time_ms_header")||(a.requestTimeMs=String(b));M("unsplit_gel_payloads_in_logs")&&(a.unsplitGelPayloadsInLogs=!0);!c&&(b=L("EVENT_ID"))&&(c=kr(),a.serializedClientEventId={serializedEventId:b,clientCounter:String(c)})}
function jr(a,b,c){M("use_request_time_ms_header")||D(a,2,b);if(!c&&(b=L("EVENT_ID"))){c=kr();var d=new ok;D(d,1,b);D(d,2,c);G(a,ok,5,d)}}
function kr(){var a=L("BATCH_CLIENT_COUNTER")||0;a||(a=Math.floor(Math.random()*Hq/2));a++;a>Hq&&(a=1);Dk("BATCH_CLIENT_COUNTER",a);return a}
...
function ir(a,b,c){if(Qd(c,1===Vd(c,qk)?1:-1))var d=1;else if(c.getPlaylistId())d=2;else return;G(a,pk,4,c);a=Wd(a,$i,1)||new $i;c=Wd(a,Yi,3)||new Yi;var e=new Xi;e.setToken(b);D(e,1,d);ae(c,12,Xi,e);G(a,Yi,3,c)}
function hr(a){for(var b=[],c=0;c<a.length;c++)try{b.push(new Sj(a[c]))}catch(d){Mk(new Q("Transport failed to deserialize "+String(a[c])))}return b}
...
;var lr=y.ytLoggingGelSequenceIdObj_||{};z("ytLoggingGelSequenceIdObj_",lr);function mr(a,b,c,d){d=void 0===d?{}:d;var e={},f=Math.round(d.timestamp||P());e.eventTimeMs=f<Number.MAX_SAFE_INTEGER?f:0;e[a]=b;a=sq();e.context={lastActivityMs:String(d.timestamp||!isFinite(a)?-1:a)};M("log_sequence_info_on_gel_web")&&d.ba&&(a=e.context,b=d.ba,b={index:nr(b),groupKey:b},a.sequence=b,d.Sb&&delete lr[d.ba]);(d.kc?$q:Uq)({endpoint:"log_event",payload:e,cttAuthInfo:d.cttAuthInfo,Fa:d.Fa},c)}
function or(a){Tq(void 0,void 0,void 0===a?!1:a)}
function nr(a){lr[a]=a in lr?lr[a]+1:0;return lr[a]}
;var pr=y.ytLoggingGelSequenceIdObj_||{};z("ytLoggingGelSequenceIdObj_",pr);function qr(a,b,c){c=void 0===c?{}:c;var d=Math.round(c.timestamp||P());D(a,1,d<Number.MAX_SAFE_INTEGER?d:0);var e=sq();d=new Rj;D(d,1,c.timestamp||!isFinite(e)?-1:e);if(M("log_sequence_info_on_gel_web")&&c.ba){e=c.ba;var f=nr(e),g=new Qj;D(g,2,f);D(g,1,e);G(d,Qj,3,g);c.Sb&&delete pr[c.ba]}G(a,Rj,33,d);(c.kc?br:Yq)({endpoint:"log_event",payload:a,cttAuthInfo:c.cttAuthInfo,Fa:c.Fa},b)}
;function rr(a,b){b=void 0===b?{}:b;var c=!1;L("ytLoggingEventsDefaultDisabled",!1)&&(c=!0);qr(a,c?null:bq,b)}
;function sr(a,b){var c=new Sj;Zd(c,Hj,72,Tj,a);rr(c,b)}
function tr(a,b,c){var d=new Sj;Zd(d,Gj,73,Tj,a);c?qr(d,c,b):rr(d,b)}
function ur(a,b,c){var d=new Sj;Zd(d,Fj,78,Tj,a);c?qr(d,c,b):rr(d,b)}
function vr(a,b,c){var d=new Sj;Zd(d,Ij,208,Tj,a);c?qr(d,c,b):rr(d,b)}
function wr(a,b,c){var d=new Sj;Zd(d,yj,156,Tj,a);c?qr(d,c,b):rr(d,b)}
function xr(a,b,c){var d=new Sj;Zd(d,Cj,215,Tj,a);c?qr(d,c,b):rr(d,b)}
function yr(a,b,c){var d=new Sj;Zd(d,uj,111,Tj,a);c?qr(d,c,b):rr(d,b)}
;function sm(a,b,c){c=void 0===c?{}:c;if(M("migrate_events_to_ts")){c=void 0===c?{}:c;var d=bq;L("ytLoggingEventsDefaultDisabled",!1)&&bq===bq&&(d=null);mr(a,b,d,c)}else d=bq,L("ytLoggingEventsDefaultDisabled",!1)&&bq==bq&&(d=null),mr(a,b,d,c)}
;var zr=[{wb:function(a){return"Cannot read property '"+a.key+"'"},
...
bb:{ReferenceError:[{regexp:/(.*) is not defined/,groups:["key"]},{regexp:/Can't find variable: (.*)/,groups:["key"]}]}}];var Br={na:[],ma:[{callback:Ar,weight:500}]};function Ar(a){if("JavaException"===a.name)return!0;a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
;function Cr(){this.ma=[];this.na=[]}
var Dr;function Er(){if(!Dr){var a=Dr=new Cr;a.na.length=0;a.ma.length=0;Br.na&&a.na.push.apply(a.na,Br.na);Br.ma&&a.ma.push.apply(a.ma,Br.ma)}return Dr}
;var Fr=new K;function Gr(a){function b(){return a.charCodeAt(d++)}
var c=a.length,d=0;do{var e=Hr(b);if(Infinity===e)break;var f=e>>3;switch(e&7){case 0:e=Hr(b);if(2===f)return e;break;case 1:if(2===f)return;d+=8;break;case 2:e=Hr(b);if(2===f)return a.substr(d,e);d+=e;break;case 5:if(2===f)return;d+=4;break;default:return}}while(d<c)}
function Hr(a){var b=a(),c=b&127;if(128>b)return c;b=a();c|=(b&127)<<7;if(128>b)return c;b=a();c|=(b&127)<<14;if(128>b)return c;b=a();return 128>b?c|(b&127)<<21:Infinity}
;function Ir(a,b,c,d){if(a)if(Array.isArray(a)){var e=d;for(d=0;d<a.length&&!(a[d]&&(e+=Jr(d,a[d],b,c),500<e));d++);d=e}else if("object"===typeof a)for(e in a){if(a[e]){var f=a[e];var g=b;var h=c;g="string"!==typeof f||"clickTrackingParams"!==e&&"trackingParams"!==e?0:(f=Gr(atob(f.replace(/-/g,"+").replace(/_/g,"/"))))?Jr(e+".ve",f,g,h):0;d+=g;d+=Jr(e,a[e],b,c);if(500<d)break}}else c[b]=Kr(a),d+=c[b].length;else c[b]=Kr(a),d+=c[b].length;return d}
function Jr(a,b,c,d){c+="."+a;a=Kr(b);d[c]=a;return c.length+a.length}
function Kr(a){try{return("string"===typeof a?a:String(JSON.stringify(a))).substr(0,500)}catch(b){return"unable to serialize "+typeof a+" ("+b.message+")"}}
;var Lr=new Set,Mr=0,Nr=0,Or=0,Pr=[],Qr=["PhantomJS","Googlebot","TO STOP THIS SECURITY SCAN go/scan"];function rm(a){Rr(a)}
function Sr(a){Rr(a,"WARNING")}
...
k.push("File name: "+a.fileName);k.push("Stacktrace: "+a.stack);window.console.log(k.join("\n"),a)}if(!(5<=Mr)){var m=Pr,q=ue(a),r=q.message||"Unknown Error",x=q.name||"UnknownError",v=q.stack||a.j||"Not available";if(v.startsWith(x+": "+r)){var A=v.split("\n");A.shift();v=A.join("\n")}var E=q.lineNumber||"Not available",F=q.fileName||"Not available",N=v,O=0;if(a.hasOwnProperty("args")&&a.args&&a.args.length)for(var R=0;R<a.args.length&&!(O=Ir(a.args[R],"params."+R,g,O),500<=O);R++);else if(a.hasOwnProperty("params")&&
a.params){var U=a.params;if("object"===typeof a.params)for(var ca in U){if(U[ca]){var lb="params."+ca,Xa=Kr(U[ca]);g[lb]=Xa;O+=lb.length+Xa.length;if(500<O)break}}else g.params=Kr(U)}if(m.length)for(var ja=0;ja<m.length&&!(O=Ir(m[ja],"params.context."+ja,g,O),500<=O);ja++);navigator.vendor&&!g.hasOwnProperty("vendor")&&(g["device.vendor"]=navigator.vendor);var H={message:r,name:x,lineNumber:E,fileName:F,stack:N,params:g,sampleWeight:1},ka=Number(a.columnNumber);isNaN(ka)||(H.lineNumber=H.lineNumber+
":"+ka);if("IGNORED"===a.level)var la=0;else a:{for(var Ce=Er(),De=p(Ce.na),td=De.next();!td.done;td=De.next()){var ud=td.value;if(H.message&&H.message.match(ud.Jq)){la=ud.weight;break a}}for(var vd=p(Ce.ma),ua=vd.next();!ua.done;ua=vd.next()){var rp=ua.value;if(rp.callback(H)){la=rp.weight;break a}}la=1}H.sampleWeight=la;for(var sp=p(zr),Uj=sp.next();!Uj.done;Uj=sp.next()){var Vj=Uj.value;if(Vj.bb[H.name])for(var tp=p(Vj.bb[H.name]),Wj=tp.next();!Wj.done;Wj=tp.next()){var up=Wj.value,Qg=H.message.match(up.regexp);
if(Qg){H.params["params.error.original"]=Qg[0];for(var Xj=up.groups,vp={},wd=0;wd<Xj.length;wd++)vp[Xj[wd]]=Qg[wd+1],H.params["params.error."+Xj[wd]]=Qg[wd+1];H.message=Vj.wb(vp);break}}}H.params||(H.params={});var wp=Er();H.params["params.errorServiceSignature"]="msg="+wp.na.length+"&cb="+wp.ma.length;H.params["params.serviceWorker"]="false";y.document&&y.document.querySelectorAll&&(H.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));Db("sample").constructor!==
Bb&&(H.params["params.fconst"]="true");window.yterr&&"function"===typeof window.yterr&&window.yterr(H);if(0!==H.sampleWeight&&!Lr.has(H.message)){if("ERROR"===h){Fr.qa("handleError",H);if(M("record_app_crashed_web")&&0===Or&&1===H.sampleWeight)if(Or++,M("errors_via_jspb")){var Yj=new rj;D(Yj,1,1);if(!M("report_client_error_with_app_crash_ks")){var xp=new mj;D(xp,1,H.message);var yp=new nj;G(yp,mj,3,xp);var zp=new oj;G(zp,nj,5,yp);var Ap=new pj;G(Ap,oj,9,zp);G(Yj,pj,4,Ap)}var Bp=new Sj;Zd(Bp,rj,20,
Tj,Yj);rr(Bp)}else{var Cp={appCrashType:"APP_CRASH_TYPE_BREAKPAD"};M("report_client_error_with_app_crash_ks")||(Cp.systemHealth={crashData:{clientError:{logMessage:{message:H.message}}}});sm("appCrashed",Cp)}Nr++}else"WARNING"===h&&Fr.qa("handleWarning",H);if(M("kevlar_gel_error_routing"))a:{var Ee=h;if(M("errors_via_jspb")){if(Tr())var Ep=void 0;else{var xd=new jj;D(xd,1,H.stack);H.fileName&&D(xd,4,H.fileName);var Gb=H.lineNumber&&H.lineNumber.split?H.lineNumber.split(":"):[];0!==Gb.length&&(1!==
Gb.length||isNaN(Number(Gb[0]))?2!==Gb.length||isNaN(Number(Gb[0]))||isNaN(Number(Gb[1]))||(D(xd,2,Number(Gb[0])),D(xd,3,Number(Gb[1]))):D(xd,2,Number(Gb[0])));var xc=new mj;D(xc,1,H.message);D(xc,3,H.name);D(xc,6,H.sampleWeight);"ERROR"===Ee?D(xc,2,2):"WARNING"===Ee?D(xc,2,1):D(xc,2,0);var Zj=new kj;D(Zj,1,!0);Zd(Zj,jj,3,lj,xd);var $b=new gj;D($b,3,window.location.href);for(var Fp=L("FEXP_EXPERIMENTS",[]),ak=0;ak<Fp.length;ak++){var Lv=Fp[ak];Dd($b);Rd($b,5).push(Lv)}var bk=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");
if(!Ek()&&bk)for(var Gp=p(Object.keys(bk)),yc=Gp.next();!yc.done;yc=Gp.next()){var Hp=yc.value,ck=new ij;D(ck,1,Hp);ck.setValue(String(bk[Hp]));ae($b,4,ij,ck)}var dk=H.params;if(dk){var Ip=p(Object.keys(dk));for(yc=Ip.next();!yc.done;yc=Ip.next()){var Jp=yc.value,ek=new ij;D(ek,1,"client."+Jp);ek.setValue(String(dk[Jp]));ae($b,4,ij,ek)}}var Kp=L("SERVER_NAME"),Lp=L("SERVER_VERSION");if(Kp&&Lp){var fk=new ij;D(fk,1,"server.name");fk.setValue(Kp);ae($b,4,ij,fk);var gk=new ij;D(gk,1,"server.version");
gk.setValue(Lp);ae($b,4,ij,gk)}var Rg=new nj;G(Rg,gj,1,$b);G(Rg,kj,2,Zj);G(Rg,mj,3,xc);Ep=Rg}var Mp=Ep;if(!Mp)break a;var Np=new Sj;Zd(Np,nj,163,Tj,Mp);rr(Np)}else{if(Tr())var Op=void 0;else{var Fe={stackTrace:H.stack};H.fileName&&(Fe.filename=H.fileName);var Hb=H.lineNumber&&H.lineNumber.split?H.lineNumber.split(":"):[];0!==Hb.length&&(1!==Hb.length||isNaN(Number(Hb[0]))?2!==Hb.length||isNaN(Number(Hb[0]))||isNaN(Number(Hb[1]))||(Fe.lineNumber=Number(Hb[0]),Fe.columnNumber=Number(Hb[1])):Fe.lineNumber=
Number(Hb[0]));var hk={level:"ERROR_LEVEL_UNKNOWN",message:H.message,errorClassName:H.name,sampleWeight:H.sampleWeight};"ERROR"===Ee?hk.level="ERROR_LEVEL_ERROR":"WARNING"===Ee&&(hk.level="ERROR_LEVEL_WARNNING");var Mv={isObfuscated:!0,browserStackInfo:Fe},yd={pageUrl:window.location.href,kvPairs:[]};L("FEXP_EXPERIMENTS")&&(yd.experimentIds=L("FEXP_EXPERIMENTS"));var ik=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(!Ek()&&ik)for(var Pp=p(Object.keys(ik)),zc=Pp.next();!zc.done;zc=Pp.next()){var Qp=
zc.value;yd.kvPairs.push({key:Qp,value:String(ik[Qp])})}var jk=H.params;if(jk){var Rp=p(Object.keys(jk));for(zc=Rp.next();!zc.done;zc=Rp.next()){var Sp=zc.value;yd.kvPairs.push({key:"client."+Sp,value:String(jk[Sp])})}}var Tp=L("SERVER_NAME"),Up=L("SERVER_VERSION");Tp&&Up&&(yd.kvPairs.push({key:"server.name",value:Tp}),yd.kvPairs.push({key:"server.version",value:Up}));Op={errorMetadata:yd,stackTrace:Mv,logMessage:hk}}var Vp=Op;if(!Vp)break a;sm("clientError",Vp)}if("ERROR"===Ee||M("errors_flush_gel_always_killswitch"))b:if(M("migrate_events_to_ts"))c:{if(M("web_fp_via_jspb")&&
(or(!0),!M("web_fp_via_jspb_and_json")))break c;or()}else{if(M("web_fp_via_jspb")&&(or(!0),!M("web_fp_via_jspb_and_json")))break b;or()}}if(!M("suppress_error_204_logging")){var Ge=H.params||{},ac={urlParams:{a:"logerror",t:"jserror",type:H.name,msg:H.message.substr(0,250),line:H.lineNumber,level:h,"client.name":Ge.name},postParams:{url:L("PAGE_NAME",window.location.href),file:H.fileName},method:"POST"};Ge.version&&(ac["client.version"]=Ge.version);if(ac.postParams){H.stack&&(ac.postParams.stack=
H.stack);for(var Wp=p(Object.keys(Ge)),kk=Wp.next();!kk.done;kk=Wp.next()){var Xp=kk.value;ac.postParams["client."+Xp]=Ge[Xp]}var lk=L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS");if(lk)for(var Yp=p(Object.keys(lk)),mk=Yp.next();!mk.done;mk=Yp.next()){var Zp=mk.value;ac.postParams[Zp]=lk[Zp]}var $p=L("SERVER_NAME"),aq=L("SERVER_VERSION");$p&&aq&&(ac.postParams["server.name"]=$p,ac.postParams["server.version"]=aq)}ml(L("ECATCHER_REPORT_HOST","")+"/error_204",ac)}try{Lr.add(H.message)}catch(lx){}Mr++}}}}
function Tr(){for(var a=p(Qr),b=a.next();!b.done;b=a.next())if(jm(b.value.toLowerCase()))return!0;return!1}
function Ur(a){var b=Ja.apply(1,arguments);a.args||(a.args=[]);a.args.push.apply(a.args,ha(b))}
;function Vr(){this.register=new Map}
function Wr(a){a=p(a.register.values());for(var b=a.next();!b.done;b=a.next())b.value.Mq("ABORTED")}
Vr.prototype.clear=function(){Wr(this);this.register.clear()};
var Xr=new Vr;var Yr=Date.now().toString();
function Zr(){a:{if(window.crypto&&window.crypto.getRandomValues)try{var a=Array(16),b=new Uint8Array(16);window.crypto.getRandomValues(b);for(var c=0;c<a.length;c++)a[c]=b[c];var d=a;break a}catch(e){}d=Array(16);for(a=0;16>a;a++){b=Date.now();for(c=0;c<b%23;c++)d[a]=Math.random();d[a]=Math.floor(256*Math.random())}if(Yr)for(a=1,b=0;b<Yr.length;b++)d[a%16]=d[a%16]^d[(a-1)%16]/4^Yr.charCodeAt(b),a++}a=[];for(b=0;b<d.length;b++)a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(d[b]&63));
return a.join("")}
;var $r=y.ytLoggingDocDocumentNonce_;$r||($r=Zr(),z("ytLoggingDocDocumentNonce_",$r));var as=$r;var bs={Kh:0,me:1,xe:2,El:3,Mh:4,Sp:5,tm:6,ao:7,wn:8,On:9,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS",7:"SHARE",8:"PUSH_NOTIFICATIONS",9:"RICH_GRID_WATCH"};function cs(a){this.i=a}
function ds(a){return new cs({trackingParams:a})}
cs.prototype.getAsJson=function(){var a={};void 0!==this.i.trackingParams?a.trackingParams=this.i.trackingParams:(a.veType=this.i.veType,void 0!==this.i.veCounter&&(a.veCounter=this.i.veCounter),void 0!==this.i.elementIndex&&(a.elementIndex=this.i.elementIndex));void 0!==this.i.dataElement&&(a.dataElement=this.i.dataElement.getAsJson());void 0!==this.i.youtubeData&&(a.youtubeData=this.i.youtubeData);return a};
cs.prototype.getAsJspb=function(){var a=new tj;if(void 0!==this.i.trackingParams){var b=this.i.trackingParams;null!=b&&b instanceof kd&&jd();D(a,1,b)}else void 0!==this.i.veType&&D(a,2,this.i.veType),void 0!==this.i.veCounter&&D(a,6,this.i.veCounter),void 0!==this.i.elementIndex&&D(a,3,this.i.elementIndex);void 0!==this.i.dataElement&&(b=this.i.dataElement.getAsJspb(),G(a,tj,7,b));void 0!==this.i.youtubeData&&G(a,Mi,8,this.i.jspbYoutubeData);return a};
cs.prototype.toString=function(){return JSON.stringify(this.getAsJson())};
cs.prototype.isClientVe=function(){return!this.i.trackingParams&&!!this.i.veType};function es(a){a=void 0===a?0:a;return 0===a?"client-screen-nonce":"client-screen-nonce."+a}
function fs(a){a=void 0===a?0:a;return 0===a?"ROOT_VE_TYPE":"ROOT_VE_TYPE."+a}
function gs(a){return L(fs(void 0===a?0:a))}
z("yt_logging_screen.getRootVeType",gs);function hs(a){return(a=gs(void 0===a?0:a))?new cs({veType:a,youtubeData:void 0,jspbYoutubeData:void 0}):null}
function is(){var a=L("csn-to-ctt-auth-info");a||(a={},Dk("csn-to-ctt-auth-info",a));return a}
function js(a){a=L(es(void 0===a?0:a));if(!a&&!L("USE_CSN_FALLBACK",!0))return null;a||(a="UNDEFINED_CSN");return a?a:null}
z("yt_logging_screen.getCurrentCsn",js);function ks(a,b,c){var d=is();(c=js(c))&&delete d[c];b&&(d[a]=b)}
function ls(a){return is()[a]}
z("yt_logging_screen.getCttAuthInfo",ls);
function ms(a,b,c,d){c=void 0===c?0:c;if(a!==L(es(c))||b!==L(fs(c)))if(ks(a,d,c),Dk(es(c),a),Dk(fs(c),b),b=function(){setTimeout(function(){if(a)if(M("web_time_via_jspb")){var e=new uj;D(e,1,as);D(e,2,a);M("use_default_heartbeat_client")?yr(e):yr(e,void 0,bq)}else e={clientDocumentNonce:as,clientScreenNonce:a},M("use_default_heartbeat_client")?sm("foregroundHeartbeatScreenAssociated",e):mr("foregroundHeartbeatScreenAssociated",e,bq)},0)},"requestAnimationFrame"in window)try{window.requestAnimationFrame(b)}catch(e){b()}else b()}
z("yt_logging_screen.setCurrentScreen",ms);var ns=window.yt&&window.yt.msgs_||window.ytcfg&&window.ytcfg.msgs||{};z("yt.msgs_",ns);function os(a){yk(ns,arguments)}
;var ps={le:3611,wd:27686,xd:85013,yd:23462,Ad:157557,Bd:42016,Cd:62407,Dd:26926,zd:43781,Ed:51236,Fd:79148,Gd:50160,Hd:77504,Td:153587,Ud:87907,Vd:18630,Wd:54445,Xd:80935,Yd:152172,Zd:105675,ae:150723,be:37521,ce:147285,de:47786,ee:98349,ge:123695,he:6827,ie:29434,je:7282,ke:124448,oe:32276,ne:76278,pe:147868,qe:147869,re:93911,se:106531,te:27259,ue:27262,we:27263,ye:21759,ze:27107,Ae:62936,Be:49568,Ce:38408,De:80637,Ee:68727,Fe:68728,Ge:80353,He:80356,Ie:74610,Je:45707,Ke:83962,Le:83970,Me:46713,
...
lq:17657,mq:17655,nq:39579,oq:39578,pq:77448,qq:8196,rq:11357,sq:69877,tq:8197,uq:156512,wq:156509,xq:82039};function qs(){var a=vb(rs),b;return(new yf(function(c,d){a.onSuccess=function(e){el(e)?c(new ss(e)):d(new ts("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
a.onError=function(e){d(new ts("Unknown request error","net.unknown",e))};
a.onTimeout=function(e){d(new ts("Request timed out","net.timeout",e))};
b=ml("//googleads.g.doubleclick.net/pagead/id",a)})).gb(function(c){c instanceof Ff&&b.abort();
return Df(c)})}
function ts(a,b,c){ab.call(this,a+", errorCode="+b);this.errorCode=b;this.xhr=c;this.name="PromiseAjaxError"}
t(ts,ab);function ss(a){this.xhr=a}
;function us(){this.i=0;this.ja=null}
us.prototype.then=function(a,b,c){return 1===this.i&&a?(a=a.call(c,this.ja))&&"function"===typeof a.then?a:vs(a):2===this.i&&b?(a=b.call(c,this.ja))&&"function"===typeof a.then?a:ws(a):this};
us.prototype.getValue=function(){return this.ja};
us.prototype.$goog_Thenable=!0;function ws(a){var b=new us;a=void 0===a?null:a;b.i=2;b.ja=void 0===a?null:a;return b}
function vs(a){var b=new us;a=void 0===a?null:a;b.i=1;b.ja=void 0===a?null:a;return b}
;function xs(a,b){if(a)return a[b.name]}
;function ys(a,b){var c=void 0===c?{}:c;a={method:void 0===b?"POST":b,mode:$k(a)?"same-origin":"cors",credentials:$k(a)?"same-origin":"include"};b={};for(var d=p(Object.keys(c)),e=d.next();!e.done;e=d.next())e=e.value,c[e]&&(b[e]=c[e]);0<Object.keys(b).length&&(a.headers=b);return a}
;function zs(){return sg()||im&&jm("applewebkit")&&!jm("version")&&(!jm("safari")||jm("gsa/"))||Qc&&jm("version/")?!0:L("EOM_VISITOR_DATA")?!1:!0}
;function As(a){a:{var b=a.raw_embedded_player_response;if(!b&&(a=a.embedded_player_response))try{b=JSON.parse(a)}catch(d){b="EMBEDDED_PLAYER_MODE_UNKNOWN";break a}if(b)b:{for(var c in Yh)if(Yh[c]==b.embeddedPlayerMode){b=Yh[c];break b}b="EMBEDDED_PLAYER_MODE_UNKNOWN"}else b="EMBEDDED_PLAYER_MODE_UNKNOWN"}return"EMBEDDED_PLAYER_MODE_PFL"===b}
;function Bs(a){ab.call(this,a.message||a.description||a.name);this.isMissing=a instanceof Cs;this.isTimeout=a instanceof ts&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof Ff}
t(Bs,ab);Bs.prototype.name="BiscottiError";function Cs(){ab.call(this,"Biscotti ID is missing from server")}
t(Cs,ab);Cs.prototype.name="BiscottiMissingError";var rs={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Ds=null;function Es(){if(M("disable_biscotti_fetch_entirely_for_all_web_clients"))return Error("Biscotti id fetching has been disabled entirely.");if(!zs())return Error("User has not consented - not fetching biscotti id.");var a=L("PLAYER_VARS",{});if("1"==tb(a))return Error("Biscotti ID is not available in private embed mode");if(As(a))return Error("Biscotti id fetching has been disabled for pfl.")}
function Pk(){var a=Es();if(void 0!==a)return Df(a);Ds||(Ds=qs().then(Fs).gb(function(b){return Gs(2,b)}));
return Ds}
function Fs(a){a=a.xhr.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new Cs;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new Cs;a=a.id;Qk(a);Ds=vs(a);Hs(18E5,2);return a}
function Gs(a,b){b=new Bs(b);Qk("");Ds=ws(b);0<a&&Hs(12E4,a-1);throw b;}
function Hs(a,b){fl(function(){qs().then(Fs,function(c){return Gs(b,c)}).gb(cb)},a)}
function Is(){try{var a=B("yt.ads.biscotti.getId_");return a?a():Pk()}catch(b){return Df(b)}}
;function Js(a){if("1"!=tb(L("PLAYER_VARS",{}))){a&&Ok();try{Is().then(function(){},function(){}),fl(Js,18E5)}catch(b){Mk(b)}}}
;function Ks(){this.od=!0}
function Ls(a){var b={},c=ug([]);c&&(b.Authorization=c,c=a=null==a?void 0:a.sessionIndex,void 0===c&&(c=Number(L("SESSION_INDEX",0)),c=isNaN(c)?0:c),M("voice_search_auth_header_removal")||(b["X-Goog-AuthUser"]=c),"INNERTUBE_HOST_OVERRIDE"in Ck||(b["X-Origin"]=window.location.origin),void 0===a&&"DELEGATED_SESSION_ID"in Ck&&(b["X-Goog-PageId"]=L("DELEGATED_SESSION_ID")));return b}
;var Ms={identityType:"UNAUTHENTICATED_IDENTITY_TYPE_UNKNOWN"};var Ns=new Map([["dark","USER_INTERFACE_THEME_DARK"],["light","USER_INTERFACE_THEME_LIGHT"]]);function Os(){var a=void 0===a?window.location.href:a;if(M("kevlar_disable_theme_param"))return null;mc(nc(5,a));try{var b=Yk(a).theme;return Ns.get(b)||null}catch(c){}return null}
;function Ps(){this.i={};if(this.j=xl()){var a=qg.get("CONSISTENCY",void 0);a&&Qs(this,{encryptedTokenJarContents:a})}}
Ps.prototype.handleResponse=function(a,b){if(!b)throw Error("request needs to be passed into ConsistencyService");var c,d;b=(null==(c=b.ga.context)?void 0:null==(d=c.request)?void 0:d.consistencyTokenJars)||[];var e;if(a=null==(e=a.responseContext)?void 0:e.consistencyTokenJar){e=p(b);for(c=e.next();!c.done;c=e.next())delete this.i[c.value.encryptedTokenJarContents];Qs(this,a)}};
function Qs(a,b){if(b.encryptedTokenJarContents&&(a.i[b.encryptedTokenJarContents]=b,"string"===typeof b.expirationSeconds)){var c=Number(b.expirationSeconds);setTimeout(function(){delete a.i[b.encryptedTokenJarContents]},1E3*c);
a.j&&wl("CONSISTENCY",b.encryptedTokenJarContents,c,void 0,!0)}}
;var Rs=window.location.hostname.split(".").slice(-2).join(".");function Ss(){var a=L("LOCATION_PLAYABILITY_TOKEN");"TVHTML5"===L("INNERTUBE_CLIENT_NAME")&&(this.i=Ts(this))&&(a=this.i.get("yt-location-playability-token"));a&&(this.locationPlayabilityToken=a,this.j=void 0)}
var Us;Ss.getInstance=function(){Us=B("yt.clientLocationService.instance");Us||(Us=new Ss,z("yt.clientLocationService.instance",Us));return Us};
Ss.prototype.setLocationOnInnerTubeContext=function(a){a.client||(a.client={});this.j?(a.client.locationInfo||(a.client.locationInfo={}),a.client.locationInfo.latitudeE7=Math.floor(1E7*this.j.coords.latitude),a.client.locationInfo.longitudeE7=Math.floor(1E7*this.j.coords.longitude),a.client.locationInfo.horizontalAccuracyMeters=Math.round(this.j.coords.accuracy),a.client.locationInfo.forceLocationPlayabilityTokenRefresh=!0):this.locationPlayabilityToken&&(a.client.locationPlayabilityToken=this.locationPlayabilityToken)};
Ss.prototype.handleResponse=function(a){var b;a=null==(b=a.responseContext)?void 0:b.locationPlayabilityToken;void 0!==a&&(this.locationPlayabilityToken=a,this.j=void 0,"TVHTML5"===L("INNERTUBE_CLIENT_NAME")?(this.i=Ts(this))&&this.i.set("yt-location-playability-token",a,15552E3):wl("YT_CL",JSON.stringify({loctok:a}),15552E3,Rs,!0))};
function Ts(a){return void 0===a.i?new Vl("yt-client-location"):a.i}
Ss.prototype.getCurrentPositionFromGeolocation=function(){var a=this;if(!(navigator&&navigator.geolocation&&navigator.geolocation.getCurrentPosition))return Promise.reject(Error("Geolocation unsupported"));var b=!1,c=1E4;"MWEB"===L("INNERTUBE_CLIENT_NAME")&&(b=!0,c=15E3);return new Promise(function(d,e){navigator.geolocation.getCurrentPosition(function(f){a.j=f;d(f)},function(f){e(f)},{enableHighAccuracy:b,
maximumAge:0,timeout:c})})};
Ss.prototype.createUnpluggedLocationInfo=function(a){var b={};a=a.coords;if(null==a?0:a.latitude)b.latitudeE7=Math.floor(1E7*a.latitude);if(null==a?0:a.longitude)b.longitudeE7=Math.floor(1E7*a.longitude);if(null==a?0:a.accuracy)b.locationRadiusMeters=Math.round(a.accuracy);return b};function Vs(a,b){var c,d=null==(c=xs(a,ej))?void 0:c.signal;if(d&&b.La&&(c=b.La[d]))return c();var e;if((c=null==(e=xs(a,cj))?void 0:e.request)&&b.Ec&&(e=b.Ec[c]))return e();for(var f in a)if(b.Ob[f]&&(a=b.Ob[f]))return a()}
;var Ws=Symbol("injectionDeps");function Xs(a){this.name=a}
Xs.prototype.toString=function(){return"InjectionToken("+this.name+")"};
function Ys(){this.key=Zs}
function $s(){this.providers=new Map;this.i=new Map}
$s.prototype.resolve=function(a){return a instanceof Ys?at(this,a.key,[],!0):at(this,a,[])};
function at(a,b,c,d){d=void 0===d?!1:d;if(-1<c.indexOf(b))throw Error("Deps cycle for: "+b);if(a.i.has(b))return a.i.get(b);if(!a.providers.has(b)){if(d)return;throw Error("No provider for: "+b);}d=a.providers.get(b);c.push(b);if(d.qc)var e=d.qc;else if(d.vd)e=d[Ws]?bt(a,d[Ws],c):[],e=d.vd.apply(d,ha(e));else if(d.pc){e=d.pc;var f=e[Ws]?bt(a,e[Ws],c):[];e=new (Function.prototype.bind.apply(e,[null].concat(ha(f))))}else throw Error("Could not resolve providers for: "+b);c.pop();d.Sq||a.i.set(b,e);
return e}
...
;function et(a){return function(){return new a}}
;var ft={},gt=(ft.WEB_UNPLUGGED="^unplugged/",ft.WEB_UNPLUGGED_ONBOARDING="^unplugged/",ft.WEB_UNPLUGGED_OPS="^unplugged/",ft.WEB_UNPLUGGED_PUBLIC="^unplugged/",ft.WEB_CREATOR="^creator/",ft.WEB_KIDS="^kids/",ft.WEB_EXPERIMENTS="^experiments/",ft.WEB_MUSIC="^music/",ft.WEB_REMIX="^music/",ft.WEB_MUSIC_EMBEDDED_PLAYER="^music/",ft.WEB_MUSIC_EMBEDDED_PLAYER="^main_app/|^sfv/",ft);
function ht(a){var b=void 0===b?"UNKNOWN_INTERFACE":b;if(1===a.length)return a[0];var c=gt[b];if(c){var d=new RegExp(c),e=p(a);for(c=e.next();!c.done;c=e.next())if(c=c.value,d.exec(c))return c}var f=[];Object.entries(gt).forEach(function(g){var h=p(g);g=h.next().value;h=h.next().value;b!==g&&f.push(h)});
d=new RegExp(f.join("|"));a.sort(function(g,h){return g.length-h.length});
e=p(a);for(c=e.next();!c.done;c=e.next())if(c=c.value,!d.exec(c))return c;return a[0]}
;function jt(){}
jt.prototype.o=function(a,b,c){b=void 0===b?{}:b;c=void 0===c?Ms:c;var d=a.clickTrackingParams,e=this.m,f=!1;f=void 0===f?!1:f;e=void 0===e?!1:e;var g=L("INNERTUBE_CONTEXT");if(g){g=wb(g);M("web_no_tracking_params_in_shell_killswitch")||delete g.clickTracking;g.client||(g.client={});var h=g.client;"MWEB"===h.clientName&&(h.clientFormFactor=L("IS_TABLET")?"LARGE_FORM_FACTOR":"SMALL_FORM_FACTOR");h.screenWidthPoints=window.innerWidth;h.screenHeightPoints=window.innerHeight;h.screenPixelDensity=Math.round(window.devicePixelRatio||
1);h.screenDensityFloat=window.devicePixelRatio||1;h.utcOffsetMinutes=-Math.floor((new Date).getTimezoneOffset());var k=void 0===k?!1:k;zl.getInstance();var m="USER_INTERFACE_THEME_LIGHT";Cl(165)?m="USER_INTERFACE_THEME_DARK":Cl(174)?m="USER_INTERFACE_THEME_LIGHT":!M("kevlar_legacy_browsers")&&window.matchMedia&&window.matchMedia("(prefers-color-scheme)").matches&&window.matchMedia("(prefers-color-scheme: dark)").matches&&(m="USER_INTERFACE_THEME_DARK");k=k?m:Os()||m;h.userInterfaceTheme=k;if(!f){if(k=
...
{},{certificationScope:r}));if(!M("web_populate_time_zone_itc_killswitch")){b:{if("undefined"!==typeof Intl)try{var x=(new Intl.DateTimeFormat).resolvedOptions().timeZone;break b}catch(lb){}x=void 0}x&&(h.timeZone=x)}(x=Hk())?h.experimentsToken=x:delete h.experimentsToken;x=Ik();Ps.i||(Ps.i=new Ps);h=Ps.i.i;r=[];q=0;for(var v in h)r[q++]=h[v];g.request=Object.assign({},g.request,{internalExperimentFlags:x,consistencyTokenJars:r});!M("web_prequest_context_killswitch")&&(v=L("INNERTUBE_CONTEXT_PREQUEST_CONTEXT"))&&
(g.request.externalPrequestContext=v);x=zl.getInstance();v=Cl(58);x=x.get("gsml","");g.user=Object.assign({},g.user);v&&(g.user.enableSafetyMode=v);x&&(g.user.lockedSafetyMode=!0);M("warm_op_csn_cleanup")?e&&(f=js())&&(g.clientScreenNonce=f):!f&&(f=js())&&(g.clientScreenNonce=f);d&&(g.clickTracking={clickTrackingParams:d});if(d=B("yt.mdx.remote.remoteClient_"))g.remoteClient=d;M("web_enable_client_location_service")&&Ss.getInstance().setLocationOnInnerTubeContext(g);try{var A=al(),E=A.bid;delete A.bid;
g.adSignalsInfo={params:[],bid:E};var F=p(Object.entries(A));for(var N=F.next();!N.done;N=F.next()){var O=p(N.value),R=O.next().value,U=O.next().value;A=R;E=U;d=void 0;null==(d=g.adSignalsInfo.params)||d.push({key:A,value:""+E})}}catch(lb){Rr(lb)}F=g}else Rr(Error("Error: No InnerTubeContext shell provided in ytconfig.")),F={};F={context:F};if(N=this.i(a)){this.j(F,N,b);var ca;b="/youtubei/v1/"+ht(this.l());(N=null==(ca=xs(a.commandMetadata,dj))?void 0:ca.apiUrl)&&(b=N);ca=b;(b=L("INNERTUBE_HOST_OVERRIDE"))&&
(ca=String(b)+String(pc(ca)));b={};b.key=L("INNERTUBE_API_KEY");M("json_condensed_response")&&(b.prettyPrint="false");ca=Zk(ca,b||{},!1);a=M("kevlar_response_command_processor_page")?Object.assign({},{command:a},void 0):Object.assign({},void 0);a={input:ca,ta:ys(ca),ga:F,config:a};a.config.Ra?a.config.Ra.identity=c:a.config.Ra={identity:c};return a}Rr(new Q("Error: Failed to create Request from Command.",a))};
ea.Object.defineProperties(jt.prototype,{m:{configurable:!0,enumerable:!0,get:function(){return!1}}});function kt(){}
t(kt,jt);kt.prototype.o=function(){return{input:"/getDatasyncIdsEndpoint",ta:ys("/getDatasyncIdsEndpoint","GET"),ga:{}}};
kt.prototype.l=function(){return[]};
kt.prototype.i=function(){};
kt.prototype.j=function(){};var lt={},mt=(lt.GET_DATASYNC_IDS=et(kt),lt);function nt(a){var b=Ja.apply(1,arguments);if(!ot(a)||b.some(function(d){return!ot(d)}))throw Error("Only objects may be merged.");
b=p(b);for(var c=b.next();!c.done;c=b.next())pt(a,c.value);return a}
function pt(a,b){for(var c in b)if(ot(b[c])){if(c in a&&!ot(a[c]))throw Error("Cannot merge an object into a non-object.");c in a||(a[c]={});pt(a[c],b[c])}else if(qt(b[c])){if(c in a&&!qt(a[c]))throw Error("Cannot merge an array into a non-array.");c in a||(a[c]=[]);rt(a[c],b[c])}else a[c]=b[c];return a}
function rt(a,b){b=p(b);for(var c=b.next();!c.done;c=b.next())c=c.value,ot(c)?a.push(pt({},c)):qt(c)?a.push(rt([],c)):a.push(c);return a}
function ot(a){return"object"===typeof a&&!Array.isArray(a)}
function qt(a){return"object"===typeof a&&Array.isArray(a)}
;function st(a,b){Zn.call(this,1,arguments);this.timer=b}
t(st,Zn);var tt=new $n("aft-recorded",st);var ut=window;function vt(){this.timing={};this.clearResourceTimings=function(){};
this.webkitClearResourceTimings=function(){};
this.mozClearResourceTimings=function(){};
this.msClearResourceTimings=function(){};
this.oClearResourceTimings=function(){}}
var S=ut.performance||ut.mozPerformance||ut.msPerformance||ut.webkitPerformance||new vt;var wt=!1,xt={'script[name="scheduler/scheduler"]':"sj",'script[name="player/base"]':"pj",'link[rel="stylesheet"][name="www-player"]':"pc",'link[rel="stylesheet"][name="player/www-player"]':"pc",'script[name="desktop_polymer/desktop_polymer"]':"dpj",'link[rel="import"][name="desktop_polymer"]':"dph",'script[name="mobile-c3"]':"mcj",'link[rel="stylesheet"][name="mobile-c3"]':"mcc",'script[name="player-plasma-ias-phone/base"]':"mcppj",'script[name="player-plasma-ias-tablet/base"]':"mcptj",'link[rel="stylesheet"][name="mobile-polymer-player-ias"]':"mcpc",
'link[rel="stylesheet"][name="mobile-polymer-player-svg-ias"]':"mcpsc",'script[name="mobile_blazer_core_mod"]':"mbcj",'link[rel="stylesheet"][name="mobile_blazer_css"]':"mbc",'script[name="mobile_blazer_logged_in_users_mod"]':"mbliuj",'script[name="mobile_blazer_logged_out_users_mod"]':"mblouj",'script[name="mobile_blazer_noncore_mod"]':"mbnj","#player_css":"mbpc",'script[name="mobile_blazer_desktopplayer_mod"]':"mbpj",'link[rel="stylesheet"][name="mobile_blazer_tablet_css"]':"mbtc",'script[name="mobile_blazer_watch_mod"]':"mbwj"};
Wa(S.clearResourceTimings||S.webkitClearResourceTimings||S.mozClearResourceTimings||S.msClearResourceTimings||S.oClearResourceTimings||cb,S);function zt(a){var b=At(a);if(b.aft)return b.aft;a=L((a||"")+"TIMING_AFT_KEYS",["ol"]);for(var c=a.length,d=0;d<c;d++){var e=b[a[d]];if(e)return e}return NaN}
function Bt(){var a;if(M("csi_use_performance_navigation_timing")||M("csi_use_performance_navigation_timing_tvhtml5")){var b,c,d,e=null==S?void 0:null==(a=S.getEntriesByType)?void 0:null==(b=a.call(S,"navigation"))?void 0:null==(c=b[0])?void 0:null==(d=c.toJSON)?void 0:d.call(c);e?(e.requestStart=Ct(e.requestStart),e.responseEnd=Ct(e.responseEnd),e.redirectStart=Ct(e.redirectStart),e.redirectEnd=Ct(e.redirectEnd),e.domainLookupEnd=Ct(e.domainLookupEnd),e.connectStart=Ct(e.connectStart),e.connectEnd=
Ct(e.connectEnd),e.responseStart=Ct(e.responseStart),e.secureConnectionStart=Ct(e.secureConnectionStart),e.domainLookupStart=Ct(e.domainLookupStart),e.isPerformanceNavigationTiming=!0,a=e):a=S.timing}else a=S.timing;return a}
function Dt(){return(M("csi_use_time_origin")||M("csi_use_time_origin_tvhtml5"))&&S.timeOrigin?Math.floor(S.timeOrigin):S.timing.navigationStart}
function Ct(a){return Math.round(Dt()+a)}
function Et(a){var b;(b=B("ytcsi."+(a||"")+"data_"))||(b={tick:{},info:{}},z("ytcsi."+(a||"")+"data_",b));return b}
function Ft(a){a=Et(a);a.info||(a.info={});return a.info}
function At(a){a=Et(a);a.tick||(a.tick={});return a.tick}
function Gt(a){a=Et(a);if(a.gel){var b=a.gel;b.gelInfos||(b.gelInfos={});b.gelTicks||(b.gelTicks={})}else a.gel={gelTicks:{},gelInfos:{}};return a.gel}
...
function Jt(a){var b=Et(a).nonce;b||(b=Zr(),Et(a).nonce=b);return b}
function Kt(a){var b=At(a||""),c=zt(a);c&&!wt&&(fo(tt,new st(Math.round(c-b._start),a)),wt=!0)}
...
;function Mt(){if(S.getEntriesByType){var a=S.getEntriesByType("paint");if(a=kb(a,function(b){return"first-paint"===b.name}))return Ct(a.startTime)}a=S.timing;
...
function Wt(a,b,c){c=Gt(c);if(c.gelInfos)c.gelInfos[a]=!0;else{var d={};c.gelInfos=(d[a]=!0,d)}if(a.match("_rid")){var e=a.split("_rid")[0];a="REQUEST_ID"}if(a in Qt){c=Qt[a];0<=eb(Rt,c)&&(b=!!b);a in Tt&&"string"===typeof b&&(b=Tt[a]+b.toUpperCase());a=b;b=c.split(".");for(var f=d={},g=0;g<b.length-1;g++){var h=b[g];f[h]={};f=f[h]}f[b[b.length-1]]="requestIds"===c?[{id:a,endpoint:e}]:a;return nt({},d)}0<=eb(Ut,a)||Sr(new Q("Unknown label logged with GEL CSI",a))}
...
W[W.LATENCY_ACTION_HOME]="LATENCY_ACTION_HOME";W[W.LATENCY_ACTION_STARTUP]="LATENCY_ACTION_STARTUP";W[W.LATENCY_ACTION_UNKNOWN]="LATENCY_ACTION_UNKNOWN";var Xt={LATENCY_NETWORK_MOBILE:2,LATENCY_NETWORK_WIFI:1,LATENCY_NETWORK_UNKNOWN:0};Xt[Xt.LATENCY_NETWORK_MOBILE]="LATENCY_NETWORK_MOBILE";Xt[Xt.LATENCY_NETWORK_WIFI]="LATENCY_NETWORK_WIFI";Xt[Xt.LATENCY_NETWORK_UNKNOWN]="LATENCY_NETWORK_UNKNOWN";
...
gu.prototype.tick=function(a,b,c,d){iu(this,"tick_"+a+"_"+b)||(c={timestamp:c,cttAuthInfo:d},M("web_csi_via_jspb")?(d=new Pj,D(d,1,a),D(d,2,b),a=new Sj,Zd(a,Pj,5,Tj,d),rr(a,c)):sm("latencyActionTicked",{tickName:a,clientActionNonce:b},c))};
gu.prototype.info=function(a,b,c){var d=Object.keys(a).join("");iu(this,"info_"+d+"_"+b)||(a=Object.assign({},a),a.clientActionNonce=b,sm("latencyActionInfo",a,{cttAuthInfo:c}))};
gu.prototype.jspbInfo=function(a,b,c){for(var d="",e=0;e<a.toJSON().length;e++)void 0!==a.toJSON()[e]&&(d=0===e?d.concat(""+e):d.concat("_"+e));iu(this,"info_"+d+"_"+b)||(D(a,2,b),b={cttAuthInfo:c},c=new Sj,Zd(c,Lj,7,Tj,a),rr(c,b))};
gu.prototype.span=function(a,b,c){var d=Object.keys(a).join("");iu(this,"span_"+d+"_"+b)||(a.clientActionNonce=b,sm("latencyActionSpan",a,{cttAuthInfo:c}))};
function iu(a,b){fu[b]=fu[b]||{count:0};var c=fu[b];c.count++;c.time=P();a.i||(a.i=dm(function(){var d=P(),e;for(e in fu)fu[e]&&6E4<d-fu[e].time&&delete fu[e];a&&(a.i=0)},0,5E3));
return 5<c.count?(6===c.count&&1>1E5*Math.random()&&(c=new Q("CSI data exceeded logging limit with key",b.split("_")),0<=b.indexOf("plev")||Sr(c)),!0):!1}
;function ju(){var a=["ol"];Ot("").info.actionType="embed";a&&Dk("TIMING_AFT_KEYS",a);Dk("TIMING_ACTION","embed");if(M("web_csi_via_jspb")){a=L("TIMING_INFO",{});var b=new Lj;a=p(Object.entries(a));for(var c=a.next();!c.done;c=a.next()){var d=p(c.value);c=d.next().value;d=d.next().value;switch(c){case "GetBrowse_rid":var e=new Oj;D(e,1,c);D(e,2,String(d));Nj(b,e);break;case "GetGuide_rid":e=new Oj;D(e,1,c);D(e,2,String(d));Nj(b,e);break;case "GetHome_rid":e=new Oj;D(e,1,c);D(e,2,String(d));Nj(b,e);
break;case "GetPlayer_rid":e=new Oj;D(e,1,c);D(e,2,String(d));Nj(b,e);break;case "GetSearch_rid":e=new Oj;D(e,1,c);D(e,2,String(d));Nj(b,e);break;case "GetSettings_rid":e=new Oj;D(e,1,c);D(e,2,String(d));Nj(b,e);break;case "GetTrending_rid":e=new Oj;D(e,1,c);D(e,2,String(d));Nj(b,e);break;case "GetWatchNext_rid":e=new Oj;D(e,1,c);D(e,2,String(d));Nj(b,e);break;case "yt_red":D(b,14,!!d);break;case "yt_ad":D(b,9,!!d)}}ku(b);b=new Lj;b=D(b,25,!0);b=D(b,1,W[Vt(L("TIMING_ACTION"))]);(a=L("PREVIOUS_ACTION"))&&
D(b,13,W[Vt(a)]);(a=L("CLIENT_PROTOCOL"))&&D(b,33,a);(a=L("CLIENT_TRANSPORT"))&&D(b,34,a);(a=js())&&"UNDEFINED_CSN"!==a&&D(b,4,a);a=lu();1!==a&&-1!==a||D(b,6,!0);a=Ft();a:{d=It();c=[];for(e=0;e<d.length;e++){var f=c,g=f.push;var h=d[e];var k=Lj;if(null==h||""==h)k=new k;else{h=JSON.parse(h);if(!Array.isArray(h))throw Error("Expected to deserialize an Array but got "+Oa(h)+": "+h);ce=h;k=new k(h);ce=null}g.call(f,k)}for(d=0;d<c.length;d++)if("cold"===Sd(c[d],3,""))break a}D(b,3,"cold");mu(a);a=nu();
if(0<a.length)for(a=p(a),c=a.next();!c.done;c=a.next())c=c.value,d=new Kj,D(d,1,c),ae(b,83,Kj,d);ku(b)}else{a=L("TIMING_INFO",{});for(b in a)a.hasOwnProperty(b)&&ou(b,a[b]);b={isNavigation:!0,actionType:Vt(L("TIMING_ACTION"))};if(a=L("PREVIOUS_ACTION"))b.previousAction=Vt(a);if(a=L("CLIENT_PROTOCOL"))b.httpProtocol=a;if(a=L("CLIENT_TRANSPORT"))b.transportProtocol=a;(a=js())&&"UNDEFINED_CSN"!==a&&(b.clientScreenNonce=a);a=lu();if(1===a||-1===a)b.isVisible=!0;a=Ft();b.loadType="cold";mu(a);a=nu();if(0<
a.length)for(b.resourceInfo=[],a=p(a),c=a.next();!c.done;c=a.next())b.resourceInfo.push({resourceCache:c.value});pu(b)}b=Ft();a=Ht();if("cold"===b.yt_lt||"cold"===a.loadType){c=At();d=Gt();d=d.gelTicks?d.gelTicks:d.gelTicks={};for(var m in c)m in d||Z(m,c[m]);m={};c=!1;d=p(Object.keys(b));for(e=d.next();!e.done;e=d.next())e=e.value,(e=Wt(e,b[e]))&&!Lt(Ht(),e)&&(nt(a,e),nt(m,e),c=!0);c&&pu(m)}z("ytglobal.timingready_",!0);m=L("TIMING_ACTION");B("ytglobal.timingready_")&&m&&"_start"in At()&&zt()&&Kt()}
function ou(a,b,c,d){null!==b&&(Ft(c)[a]=b,(a=Wt(a,b,c))&&pu(a,c,d))}
function pu(a,b,c){if(!M("web_csi_via_jspb")||(void 0===c?0:c))c=Ot(b||""),nt(c.info,a),nt(Ht(b),a),c=Jt(b),b=Et(b).cttAuthInfo,hu().info(a,c,b);else{c=new Lj;var d=Object.keys(a);a=Object.values(a);for(var e=0;e<d.length;e++){var f=d[e];try{switch(f){case "actionType":D(c,1,W[a[e]]);break;case "clientActionNonce":D(c,2,a[e]);break;case "clientScreenNonce":D(c,4,a[e]);break;case "loadType":D(c,3,a[e]);break;case "isPrewarmedLaunch":D(c,92,a[e]);break;case "isFirstInstall":D(c,55,a[e]);break;case "networkType":D(c,
5,Xt[a[e]]);break;case "connectionType":D(c,26,X[a[e]]);break;case "detailedConnectionType":D(c,27,Y[a[e]]);break;case "isVisible":D(c,6,a[e]);break;case "playerType":D(c,7,Yt[a[e]]);break;case "clientPlaybackNonce":D(c,8,a[e]);break;case "adClientPlaybackNonce":D(c,28,a[e]);break;case "previousCpn":D(c,77,a[e]);break;case "targetCpn":D(c,76,a[e]);break;case "isMonetized":D(c,9,a[e]);break;case "isPrerollAllowed":D(c,16,a[e]);break;case "isPrerollShown":D(c,17,a[e]);break;case "adType":D(c,12,a[e]);
break;case "adTypesAllowed":D(c,36,a[e]);break;case "adNetworks":D(c,37,a[e]);break;case "previousAction":D(c,13,W[a[e]]);break;case "isRedSubscriber":D(c,14,a[e]);break;case "serverTimeMs":D(c,15,a[e]);break;case "videoId":c.setVideoId(a[e]);break;case "adVideoId":D(c,20,a[e]);break;case "targetVideoId":D(c,78,a[e]);break;case "adBreakType":D(c,21,Zt[a[e]]);break;case "isNavigation":D(c,25,a[e]);break;case "viewportHeight":D(c,29,a[e]);break;case "viewportWidth":D(c,30,a[e]);break;case "screenHeight":D(c,
...
case "appInstallDataAgeMs":D(c,73,a[e]);break;case "latencyActionError":D(c,71,$t[a[e]]);break;case "actionStep":D(c,79,a[e]);break;case "jsHeapSizeLimit":D(c,80,a[e]);break;case "totalJsHeapSize":D(c,81,a[e]);break;case "usedJsHeapSize":D(c,82,a[e]);break;case "sourceVideoDurationMs":D(c,90,a[e]);break;case "videoOutputFrames":D(c,93,a[e]);break;case "isResume":D(c,104,a[e]);break;case "adPrebufferedTimeSecs":D(c,39,a[e]);break;case "isLivestream":D(c,47,a[e]);break;case "liveStreamMode":D(c,91,
au[a[e]]);break;case "adCpn2":D(c,48,a[e]);break;case "adDaiDriftMillis":D(c,49,a[e]);break;case "videoStreamType":D(c,53,bu[a[e]]);break;case "playbackRequiresTap":D(c,56,a[e]);break;case "performanceNavigationTiming":D(c,67,a[e]);break;case "transactionType":D(c,74,cu[a[e]]);break;case "playerRotationType":D(c,101,du[a[e]]);break;case "allowedPreroll":D(c,10,a[e]);break;case "shownPreroll":D(c,11,a[e]);break;case "getHomeRequestId":D(c,57,a[e]);break;case "getSearchRequestId":D(c,60,a[e]);break;
case "getPlayerRequestId":D(c,61,a[e]);break;case "getWatchNextRequestId":D(c,62,a[e]);break;case "getBrowseRequestId":D(c,63,a[e]);break;case "getLibraryRequestId":D(c,66,a[e]);break;default:eu.includes(f)&&Mk(new Q("Codegen laipb translator asked to translate message field",""+f))}}catch(g){Mk(Error("Codegen laipb translator failed to set "+f))}}ku(c,b)}}
function ku(a,b){It(b).push(de(a));Ot(b||"").jspbInfo.push(a);var c=Jt(b);b=Et(b).cttAuthInfo;hu().jspbInfo(a,c,b)}
function Z(a,b,c){if(!b&&"_"!==a[0]){var d=a;S.mark&&(0==d.lastIndexOf("mark_",0)||(d="mark_"+d),c&&(d+=" ("+c+")"),S.mark(d))}d=Ot(c||"");d.tick[a]=b||P();if(d.callback&&d.callback[a]){d=p(d.callback[a]);for(var e=d.next();!e.done;e=d.next())e=e.value,e()}d=Gt(c);d.gelTicks&&(d.gelTicks[a]=!0);d=At(c);e=b||P();d[a]=e;e=Jt(c);var f=Et(c).cttAuthInfo;if("_start"===a){var g=hu();iu(g,"baseline_"+e)||(b={timestamp:b,cttAuthInfo:f},M("web_csi_via_jspb")?(f=new Jj,D(f,1,e),e=new Sj,Zd(e,Jj,6,Tj,f),rr(e,
b)):sm("latencyActionBaselined",{clientActionNonce:e},b))}else hu().tick(a,e,b,f);Kt(c);return d[a]}
function qu(){var a=Jt();requestAnimationFrame(function(){setTimeout(function(){a===Jt()&&Z("ol",void 0,void 0)},0)})}
function lu(){var a=document;if("visibilityState"in a)a=a.visibilityState;else{var b=dq+"VisibilityState";a=b in a?a[b]:void 0}switch(a){case "hidden":return 0;case "visible":return 1;case "prerender":return 2;case "unloaded":return 3;default:return-1}}
function mu(a){var b=Bt(),c=Dt(),d=L("CSI_START_TIMESTAMP_MILLIS",0);0<d&&!M("embeds_web_enable_csi_start_override_killswitch")&&(c=d);c&&(Z("srt",b.responseStart),1!==a.prerender&&Z("_start",c,void 0));a=Mt();0<a&&Z("fpt",a);a=Bt();a.isPerformanceNavigationTiming&&pu({performanceNavigationTiming:!0});Z("nreqs",a.requestStart,void 0);Z("nress",a.responseStart,void 0);Z("nrese",a.responseEnd,void 0);0<a.redirectEnd-a.redirectStart&&(Z("nrs",a.redirectStart,void 0),Z("nre",a.redirectEnd,void 0));0<
a.domainLookupEnd-a.domainLookupStart&&(Z("ndnss",a.domainLookupStart,void 0),Z("ndnse",a.domainLookupEnd,void 0));0<a.connectEnd-a.connectStart&&(Z("ntcps",a.connectStart,void 0),Z("ntcpe",a.connectEnd,void 0));a.secureConnectionStart>=Dt()&&0<a.connectEnd-a.secureConnectionStart&&(Z("nstcps",a.secureConnectionStart,void 0),Z("ntcpe",a.connectEnd,void 0));S&&"getEntriesByType"in S&&ru()}
function su(a,b){a=document.querySelector(a);if(!a)return!1;var c="",d=a.nodeName;"SCRIPT"===d?(c=a.src,c||(c=a.getAttribute("data-timing-href"))&&(c=window.location.protocol+c)):"LINK"===d&&(c=a.href);ic()&&a.setAttribute("nonce",ic());return c?(a=S.getEntriesByName(c))&&a[0]&&(a=a[0],c=Dt(),Z("rsf_"+b,c+Math.round(a.fetchStart)),Z("rse_"+b,c+Math.round(a.responseEnd)),void 0!==a.transferSize&&0===a.transferSize)?!0:!1:!1}
function nu(){var a=[];if(document.querySelector&&S&&S.getEntriesByName)for(var b in xt)if(xt.hasOwnProperty(b)){var c=xt[b];su(b,c)&&a.push(c)}return a}
...
(b=ib(b,function(c,d){return d.duration>c.duration?d:c},{duration:0}))&&0<b.startTime&&0<b.responseEnd&&(Z("wffs",Ct(b.startTime)),Z("wffe",Ct(b.responseEnd)))}
...
function yu(a){var b={signalServiceEndpoint:{signal:"GET_DATASYNC_IDS"}};var c=void 0===c?Ms:c;var d=Vs(b,a.o);if(!d)return Df(new Q("Error: No request builder found for command.",b));var e=d.o(b,void 0,c);return e?new yf(function(f){var g,h,k;return w(function(m){if(1==m.i){h="cors"===(null==(g=e.ta)?void 0:g.mode)?"cors":void 0;if(a.m.od){var q=e.config,r;q=null==q?void 0:null==(r=q.Ra)?void 0:r.sessionIndex;r=Ls({sessionIndex:q});k=Object.assign({},zu(h),r);return m.u(2)}return u(m,Au(e.config,
h),3)}2!=m.i&&(k=m.j);f(Bu(a,e,k));m.i=0})}):Df(new Q("Error: Failed to build request for command.",b))}
function Bu(a,b,c){var d,e,f,g,h,k,m,q,r,x,v,A,E,F,N,O,R,U,ca,lb,Xa,ja,H,ka,la,Ce,De,td,ud,vd;return w(function(ua){switch(ua.i){case 1:ua.u(2);break;case 3:if((d=ua.j)&&!d.isExpired())return ua.return(Promise.resolve(d.i()));case 2:if(null==(e=b)?0:null==(f=e.ga)?0:f.context)for(g=p([]),h=g.next();!h.done;h=g.next())k=h.value,k.Lq(b.ga.context);if(null==(m=a.j)?0:m.Rq(b.input,b.ga))return ua.return(a.j.Iq(b.input,b.ga));(x=null==(r=b.config)?void 0:r.Ba)&&a.i.has(x)&&M("web_memoize_inflight_requests")?
q=a.i.get(x):(v=JSON.stringify(b.ga),F=null!=(E=null==(A=b.ta)?void 0:A.headers)?E:{},b.ta=Object.assign({},b.ta,{headers:Object.assign({},F,c)}),N=Object.assign({},b.ta),"POST"===b.ta.method&&(N=Object.assign({},N,{body:v})),(null==(O=b.config)?0:O.Zc)&&Z(b.config.Zc),R=function(){return a.M.fetch(b.input,N,b.config)},q=R(),x&&a.i.set(x,q));
return u(ua,q,4);case 4:U=ua.j;if(M("web_one_platform_error_handling")&&(null==(ca=U)?0:null==(lb=ca.error)?0:lb.details))for(Xa=U.error.details,ja=p(Xa),H=ja.next();!H.done;H=ja.next())ka=H.value,(la=ka["@type"])&&-1<vu.indexOf(la)&&(delete ka["@type"],U=ka);x&&a.i.has(x)&&a.i.delete(x);(null==(Ce=b.config)?0:Ce.bd)&&Z(b.config.bd);if(U||null==(De=a.j)||!De.Cq(b.input,b.ga)){ua.u(5);break}return u(ua,a.j.Hq(b.input,b.ga),6);case 6:U=ua.j;case 5:if(U&&(null==(td=U.Qq)||!td.Tq)&&a.l)for(ud=p(uu),h=
ud.next();!h.done;h=ud.next())vd=h.value,a.l[vd]&&a.l[vd].handleResponse(U,b);return ua.return(U)}})}
function Au(a,b){var c,d,e,f;return w(function(g){if(1==g.i){e=null==(c=a)?void 0:null==(d=c.Ra)?void 0:d.sessionIndex;var h=Ls({sessionIndex:e});if(!(h instanceof yf)){var k=new yf(cb);zf(k,2,h);h=k}return u(g,h,2)}f=g.j;return g.return(Promise.resolve(Object.assign({},zu(b),f)))})}
...
;var Cu=new Xs("INNERTUBE_TRANSPORT_TOKEN");var Du=["share/get_web_player_share_panel"],Eu=["feedback"],Fu=["notification/modify_channel_preference"],Gu=["browse/edit_playlist"],Hu=["subscription/subscribe"],Iu=["subscription/unsubscribe"];function Ju(){}
t(Ju,jt);Ju.prototype.l=function(){return Hu};
Ju.prototype.i=function(a){return xs(a,xk)||void 0};
...
t(Ku,jt);Ku.prototype.l=function(){return Iu};
Ku.prototype.i=function(a){return xs(a,wk)||void 0};
...
t(Lu,jt);Lu.prototype.l=function(){return Eu};
Lu.prototype.i=function(a){return xs(a,fj)||void 0};
...
t(Mu,jt);Mu.prototype.l=function(){return Fu};
Mu.prototype.i=function(a){return xs(a,vk)||void 0};
Mu.prototype.j=function(a,b){b.params&&(a.params=b.params);b.secondaryParams&&(a.secondaryParams=b.secondaryParams)};function Nu(){}
t(Nu,jt);Nu.prototype.l=function(){return Gu};
Nu.prototype.i=function(a){return xs(a,uk)||void 0};
...
t(Ou,jt);Ou.prototype.l=function(){return Du};
Ou.prototype.i=function(a){return xs(a,tk)};
Ou.prototype.j=function(a,b,c){c=void 0===c?{}:c;b.serializedShareEntity&&(a.serializedSharedEntity=b.serializedShareEntity);c.includeListId&&(a.includeListId=!0)};var Zs=new Xs("NETWORK_SLI_TOKEN");function Pu(a){this.i=a}
Pu.prototype.fetch=function(a,b){var c=this,d,e;return w(function(f){c.i&&(d=mc(nc(5,Dc(a,"key")))||"/UNKNOWN_PATH",c.i.start(d));e=new window.Request(a,b);return M("web_fetch_promise_cleanup_killswitch")?f.return(Promise.resolve(fetch(e).then(function(g){return c.handleResponse(g)}).catch(function(g){Sr(g)}))):f.return(fetch(e).then(function(g){return c.handleResponse(g)}).catch(function(g){Sr(g)}))})};
Pu.prototype.handleResponse=function(a){var b=a.text().then(function(c){return JSON.parse(c.replace(")]}'",""))});
a.redirected||a.ok?this.i&&this.i.success():(this.i&&this.i.failure(),b=b.then(function(c){Sr(new Q("Error: API fetch failed",a.status,a.url,c));return Object.assign({},c,{errorMetadata:{status:a.status}})}));
return b};
Pu[Ws]=[new Ys];var Qu=new Xs("NETWORK_MANAGER_TOKEN");var Ru;function Su(a){Zn.call(this,1,arguments);this.csn=a}
t(Su,Zn);var io=new $n("screen-created",Su),Tu=[],Vu=Uu,Wu=0;function Xu(a,b,c,d,e,f,g){function h(){Sr(new Q("newScreen() parent element does not have a VE - rootVe",b))}
var k=Vu();f=new cs({veType:b,youtubeData:f,jspbYoutubeData:void 0});e={cttAuthInfo:e,ba:k};if(M("il_via_jspb")){var m=new yj;m.V(k);zj(m,f.getAsJspb());c&&c.visualElement?(f=new Aj,c.clientScreenNonce&&D(f,2,c.clientScreenNonce),Bj(f,c.visualElement.getAsJspb()),g&&D(f,4,nk[g]),G(m,Aj,5,f)):c&&h();d&&D(m,3,d);wr(m,e,a)}else f={csn:k,pageVe:f.getAsJson()},c&&c.visualElement?(f.implicitGesture={parentCsn:c.clientScreenNonce,gesturedVe:c.visualElement.getAsJson()},g&&(f.implicitGesture.gestureType=
g)):c&&h(),d&&(f.cloneCsn=d),a?mr("screenCreated",f,a,e):sm("screenCreated",f,e);fo(io,new Su(k));return k}
function Yu(a,b,c,d){var e=d.filter(function(k){k.csn!==b?(k.csn=b,k=!0):k=!1;return k}),f={cttAuthInfo:ls(b),
ba:b};d=p(d);for(var g=d.next();!g.done;g=d.next())g=g.value.getAsJson(),(rb(g)||!g.trackingParams&&!g.veType)&&Sr(Error("Child VE logged with no data"));if(M("il_via_jspb")){var h=new Cj;h.V(b);Ej(h,c.getAsJspb());hb(e,function(k){k=k.getAsJspb();ae(h,3,tj,k)});
"UNDEFINED_CSN"==b?Zu("visualElementAttached",h,f):xr(h,f,a)}else c={csn:b,parentVe:c.getAsJson(),childVes:hb(e,function(k){return k.getAsJson()})},"UNDEFINED_CSN"==b?Zu("visualElementAttached",c,f):a?mr("visualElementAttached",c,a,f):sm("visualElementAttached",c,f)}
function Uu(){for(var a=Math.random()+"",b=[],c=0,d=0;d<a.length;d++){var e=a.charCodeAt(d);255<e&&(b[c++]=e&255,e>>=8);b[c++]=e}return fd(b,3)}
function Zu(a,b,c){Tu.push({payloadName:a,payload:b,options:c});Wu||(Wu=jo())}
function ko(a){if(Tu){for(var b=p(Tu),c=b.next();!c.done;c=b.next())if(c=c.value,c.payload)if(M("il_via_jspb"))switch(c.payload.V(a.csn),c.payloadName){case "screenCreated":wr(c.payload,c.options);break;case "visualElementAttached":xr(c.payload,c.options);break;case "visualElementShown":sr(c.payload,c.options);break;case "visualElementHidden":tr(c.payload,c.options);break;case "visualElementGestured":ur(c.payload,c.options);break;case "visualElementStateChanged":vr(c.payload,c.options);break;default:Sr(new Q("flushQueue unable to map payloadName to JSPB setter"))}else c.payload.csn=
a.csn,mr(c.payloadName,c.payload,null,c.options);Tu.length=0}Wu=0}
...
Na($u);function av(){this.o=[];this.N=[];this.i=[];this.m=[];this.B=[];this.j=new Set;this.v=new Map}
av.prototype.s=function(a){this.client=a};
function bv(a,b,c){c=void 0===c?0:c;b.then(function(d){a.j.has(c)&&a.l&&a.l();var e=js(c),f=hs(c);if(e&&f){var g;(null==d?0:null==(g=d.response)?0:g.trackingParams)&&Yu(a.client,e,f,[ds(d.response.trackingParams)]);var h;(null==d?0:null==(h=d.playerResponse)?0:h.trackingParams)&&Yu(a.client,e,f,[ds(d.playerResponse.trackingParams)])}})}
function cv(a,b,c,d){d=void 0===d?0:d;if(a.j.has(d))a.o.push([b,c]);else{var e=js(d);c=c||hs(d);e&&c&&Yu(a.client,e,c,[b])}}
av.prototype.clickCommand=function(a,b,c){var d=a.clickTrackingParams;c=void 0===c?0:c;if(d)if(c=js(void 0===c?0:c)){a=this.client;var e=ds(d);d={cttAuthInfo:ls(c),ba:c};if(M("il_via_jspb")){var f=new Fj;f.V(c);e=e.getAsJspb();G(f,tj,2,e);D(f,4,nk.INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK);b&&G(f,wj,3);"UNDEFINED_CSN"==c?Zu("visualElementGestured",f,d):ur(f,d,a)}else f={csn:c,ve:e.getAsJson(),gestureType:"INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK"},b&&(f.clientData=b),"UNDEFINED_CSN"==c?
Zu("visualElementGestured",f,d):a?mr("visualElementGestured",f,a,d):sm("visualElementGestured",f,d);b=!0}else b=!1;else b=!1;return b};
function dv(a,b,c){c=void 0===c?{}:c;a.j.add(c.layer||0);a.l=function(){ev(a,b,c);var f=hs(c.layer);if(f){for(var g=p(a.o),h=g.next();!h.done;h=g.next())h=h.value,cv(a,h[0],h[1]||f,c.layer);f=p(a.N);for(g=f.next();!g.done;g=f.next()){var k=g.value;g=void 0;g=void 0===g?0:g;h=js(g);var m=k[0]||hs(g);if(h&&m){g=a.client;var q=k[1];k={cttAuthInfo:ls(h),ba:h};M("il_via_jspb")?(q=new Ij,q.V(h),m=m.getAsJspb(),G(q,tj,2,m),"UNDEFINED_CSN"==h?Zu("visualElementStateChanged",q,k):vr(q,k,g)):(m={csn:h,ve:m.getAsJson(),
clientData:q},"UNDEFINED_CSN"==h?Zu("visualElementStateChanged",m,k):g?mr("visualElementStateChanged",m,g,k):sm("visualElementStateChanged",m,k))}}}};
js(c.layer)||a.l();if(c.Rb)for(var d=p(c.Rb),e=d.next();!e.done;e=d.next())bv(a,e.value,c.layer);else Rr(Error("Delayed screen needs a data promise."))}
function ev(a,b,c){c=void 0===c?{}:c;c.layer||(c.layer=0);var d=void 0!==c.Vc?c.Vc:c.layer;var e=js(d);d=hs(d);var f;d&&(void 0!==c.parentCsn?f={clientScreenNonce:c.parentCsn,visualElement:d}:e&&"UNDEFINED_CSN"!==e&&(f={clientScreenNonce:e,visualElement:d}));var g,h=L("EVENT_ID");"UNDEFINED_CSN"===e&&h&&(g={servletData:{serializedServletEventId:h}});try{var k=Xu(a.client,b,f,c.Qb,c.cttAuthInfo,g,c.Fq)}catch(m){Ur(m,{Oq:b,rootVe:d,parentVisualElement:void 0,Dq:e,Kq:f,Qb:c.Qb});Rr(m);return}ms(k,b,
c.layer,c.cttAuthInfo);if(b=e&&"UNDEFINED_CSN"!==e&&d){a:{b=p(Object.values(bs));for(f=b.next();!f.done;f=b.next())if(js(f.value)===e){b=!0;break a}b=!1}b=!b}b&&(b=a.client,g=!0,h=(g=void 0===g?!1:g)?16:8,f={cttAuthInfo:ls(e),ba:e,Sb:g},M("il_via_jspb")?(h=new Gj,h.V(e),d=d.getAsJspb(),G(h,tj,2,d),D(h,4,g?16:8),"UNDEFINED_CSN"==e?Zu("visualElementHidden",h,f):tr(h,f,b)):(d={csn:e,ve:d.getAsJson(),eventType:h},"UNDEFINED_CSN"==e?Zu("visualElementHidden",d,f):b?mr("visualElementHidden",d,b,f):sm("visualElementHidden",
d,f)));a.i[a.i.length-1]&&!a.i[a.i.length-1].csn&&(a.i[a.i.length-1].csn=k||"");pu({clientScreenNonce:k});$u.getInstance().clear();d=hs(c.layer);e&&"UNDEFINED_CSN"!==e&&d&&(M("web_mark_root_visible")||M("music_web_mark_root_visible"))&&(e=k,k={cttAuthInfo:ls(e),ba:e},M("il_via_jspb")?(b=new Hj,b.V(e),f=d.getAsJspb(),G(b,tj,2,f),D(b,4,1),"UNDEFINED_CSN"==e?Zu("visualElementShown",b,k):sr(b,k)):(b={csn:e,ve:d.getAsJson(),eventType:1},"UNDEFINED_CSN"==e?Zu("visualElementShown",b,k):sm("visualElementShown",
b,k)));a.j.delete(c.layer||0);a.l=void 0;e=p(a.v);for(k=e.next();!k.done;k=e.next())b=p(k.value),k=b.next().value,b=b.next().value,b.has(c.layer)&&d&&cv(a,k,d,c.layer);for(c=0;c<a.m.length;c++){e=a.m[c];try{e()}catch(m){Rr(m)}}for(c=a.m.length=0;c<a.B.length;c++){e=a.B[c];try{e()}catch(m){Rr(m)}}}
;function fv(){var a,b;return w(function(c){if(1==c.i)return a=dt().resolve(Cu),a?u(c,yu(a),2):(Sr(Error("InnertubeTransportService unavailable in fetchDatasyncIds")),c.return(void 0));if(b=c.j)return b.errorMetadata?(Sr(Error("Datasync IDs fetch responded with "+b.errorMetadata.status+": "+b.error)),c.return(void 0)):c.return(b.Eq);Sr(Error("Network request to get Datasync IDs failed."));return c.return(void 0)})}
;var gv=y.caches,hv;function iv(a){var b=a.indexOf(":");return-1===b?{dc:a}:{dc:a.substring(0,b),datasyncId:a.substring(b+1)}}
function jv(){return w(function(a){if(void 0!==hv)return a.return(hv);hv=new Promise(function(b){var c;return w(function(d){switch(d.i){case 1:return ya(d,2),u(d,gv.open("test-only"),4);case 4:return u(d,gv.delete("test-only"),5);case 5:za(d,3);break;case 2:if(c=Aa(d),c instanceof Error&&"SecurityError"===c.name)return b(!1),d.return();case 3:b("caches"in window),d.i=0}})});
return a.return(hv)})}
function kv(a){var b,c,d,e,f,g,h;w(function(k){if(1==k.i)return u(k,jv(),2);if(3!=k.i){if(!k.j)return k.return(!1);b=[];return u(k,gv.keys(),3)}c=k.j;d=p(c);for(e=d.next();!e.done;e=d.next())f=e.value,g=iv(f),h=g.datasyncId,!h||a.includes(h)||b.push(gv.delete(f));return k.return(Promise.all(b).then(function(m){return m.some(function(q){return q})}))})}
function lv(){var a,b,c,d,e,f,g;return w(function(h){if(1==h.i)return u(h,jv(),2);if(3!=h.i){if(!h.j)return h.return(!1);a=wm("cache contains other");return u(h,gv.keys(),3)}b=h.j;c=p(b);for(d=c.next();!d.done;d=c.next())if(e=d.value,f=iv(e),(g=f.datasyncId)&&g!==a)return h.return(!0);return h.return(!1)})}
...
function pv(){if(!mv())return!1;var a=wm(),b=Object.keys(window.localStorage);b=p(b);for(var c=b.next();!c.done;c=b.next())if(c=nv(c.value),void 0!==c&&c!==a)return!0;return!1}
;function qv(){fv().then(function(a){a&&(Gn(a),kv(a),ov(a))})}
function rv(){var a=new Qo;Xh.S(function(){var b,c,d,e;return w(function(f){switch(f.i){case 1:if(M("ytidb_clear_optimizations_killswitch")){f.u(2);break}b=wm("clear");if(b.startsWith("V")){var g=[b];Gn(g);kv(g);ov(g);return f.return()}c=pv();return u(f,lv(),3);case 3:return d=f.j,u(f,Hn(),4);case 4:if(e=f.j,!c&&!d&&!e)return f.return();case 2:a.L()?qv():a.m.add("publicytnetworkstatus-online",qv,!0,void 0,void 0),f.i=0}})})}
...
function zv(a,b,c){c=void 0===c?null:c;var d=Av(a),e=document.getElementById(d),f=e&&uv(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=xq(d,b),b=""+Ra(b),Bv[b]=f),g||(e=Cv(a,d,function(){uv(e,"loaded")||(sv(e),Aq(d),fl(Ya(Bq,d),0))},c)))}
function Cv(a,b,c,d){d=void 0===d?null:d;var e=kf("SCRIPT");e.id=b;e.onload=function(){c&&setTimeout(c,0)};
...
function Dv(a){a=Av(a);var b=document.getElementById(a);b&&(Bq(a),b.parentNode.removeChild(b))}
function Ev(a,b){a&&b&&(a=""+Ra(b),(a=Bv[a])&&zq(a))}
function Av(a){var b=document.createElement("a");fc(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+kc(a)}
var Bv={};var Fv=[],Gv=!1;function Hv(){if(!M("disable_biscotti_fetch_for_ad_blocker_detection")&&!M("disable_biscotti_fetch_entirely_for_all_web_clients")&&zs()){var a=L("PLAYER_VARS",{});if("1"!=tb(a)&&!As(a)){var b=function(){Gv=!0;"google_ad_status"in window?Dk("DCLKSTAT",1):Dk("DCLKSTAT",2)};
try{yv("//static.doubleclick.net/instream/ad_status.js",b)}catch(c){}Fv.push(Xh.S(function(){if(!(Gv||"google_ad_status"in window)){try{Ev("//static.doubleclick.net/instream/ad_status.js",b)}catch(c){}Gv=!0;Dk("DCLKSTAT",3)}},5E3))}}}
...
d,a.program,b,c)}else Sr(Error("Cannot initialize botguard without program"))};
function Kv(a,b,c,d,e,f){var g=void 0===g?"trayride":g;c?(a.state=2,yv(c,function(){window[g]?Nv(a,d,g,e):(a.state=3,Dv(c),Sr(new Q("Unable to load Botguard","from "+c)))},f)):b?(f=kf("SCRIPT"),f.textContent=b,f.nonce=ic(),document.head.appendChild(f),document.head.removeChild(f),window[g]?Nv(a,d,g,e):(a.state=4,Sr(new Q("Unable to load Botguard from JS")))):Sr(new Q("Unable to load VM; no url or JS provided"))}
l.isInitialized=function(){return!!this.sb()};
l.getState=function(){return this.state};
function Nv(a,b,c,d){a.state=5;try{var e=new Ch({program:b,globalName:c});e.ld.then(function(){a.state=6;d&&d(b)});
a.Cb(e)}catch(f){a.state=7,f instanceof Error&&Sr(f)}}
l.invoke=function(a){a=void 0===a?{}:a;var b=this.sb();if(b){var c={Pb:a};if(b.Wa)throw Error("Already disposed");a=Ah();var d;null!=(d=b.ra)&&d.j.i.Fb("/client_streamz/bg/fsc",d.Ba);d=b.pd([c.Pb,c.nd]);null!=(b=b.ra)&&(a=Ah()-a,b.l.i.hb("/client_streamz/bg/fsl",a,b.Ba));b=d}else b=null;return b};
l.dispose=function(){this.Gb()};
l.Gb=function(){this.Cb(null);this.state=8};
l.sb=function(){return this.i};
l.Cb=function(a){pe(this.i);this.i=a};function Ov(){return B("yt.abuse.playerAttLoader")||null}
function Pv(){Jv.apply(this,arguments)}
t(Pv,Jv);Pv.prototype.Gb=function(){this.state=8};
Pv.prototype.sb=function(){return Ov()};
Pv.prototype.Cb=function(a){pe(Ov());z("yt.abuse.playerAttLoader",a)};var Qv=new Pv;var Rv=new Jv;function Sv(){return M("use_player_abuse_bg_library")?Qv.isInitialized():Rv.isInitialized()}
function Tv(a){a=void 0===a?{}:a;M("use_player_abuse_bg_library")?(a=void 0===a?{}:a,a=Qv.invoke(a)):a=Rv.invoke(a);return a}
;function Uv(a){var b=this;var c=void 0===c?0:c;var d=void 0===d?hm():d;this.m=c;this.l=d;this.j=new Bh;this.i=a;a={};c=p(this.i.entries());for(d=c.next();!d.done;a={Ca:a.Ca,Na:a.Na},d=c.next()){var e=p(d.value);d=e.next().value;e=e.next().value;a.Na=d;a.Ca=e;d=function(f){return function(){f.Ca.vb();b.i[f.Na].eb=!0;b.i.every(function(g){return!0===g.eb})&&b.j.resolve()}}(a);
e=dm(d,Vv(this,a.Ca));this.i[a.Na]=Object.assign({},a.Ca,{vb:d,Za:e})}}
function Wv(a){var b=Array.from(a.i.keys()).sort(function(d,e){return Vv(a,a.i[e])-Vv(a,a.i[d])});
b=p(b);for(var c=b.next();!c.done;c=b.next())c=a.i[c.value],void 0===c.Za||c.eb||(a.l.fa(c.Za),dm(c.vb,10))}
Uv.prototype.cancel=function(){for(var a=p(this.i),b=a.next();!b.done;b=a.next())b=b.value,void 0===b.Za||b.eb||this.l.fa(b.Za),b.eb=!0;this.j.resolve()};
function Vv(a,b){var c;return null!=(c=b.priority)?c:a.m}
;function Xv(a){this.state=a;this.plugins=[];this.s=void 0}
Xv.prototype.install=function(){this.plugins.push.apply(this.plugins,ha(Ja.apply(0,arguments)))};
Xv.prototype.transition=function(a,b){var c=this,d=this.B.find(function(f){return f.from===c.state&&f.F===a});
...
aw.prototype.install=function(){var a=Ja.apply(0,arguments);this.i.install.apply(this.i,ha(a));this.j.install.apply(this.j,ha(a))};function bw(){aw.call(this);var a={};this.install((a.document_disposed={callback:this.l},a));a={};this.install((a.flush_logs={callback:this.m},a))}
var cw;t(bw,aw);bw.prototype.m=function(){if(M("web_fp_via_jspb")){var a=new sj,b=js();b&&a.V(b);b=new Sj;Zd(b,sj,380,Tj,a);rr(b);M("web_fp_via_jspb_and_json")&&sm("finalPayload",{csn:js()})}else sm("finalPayload",{csn:js()})};
bw.prototype.l=function(){Wr(Xr)};function dw(){}
dw.getInstance=function(){var a=B("ytglobal.storage_");a||(a=new dw,z("ytglobal.storage_",a));return a};
dw.prototype.estimate=function(){var a,b,c;return w(function(d){a=navigator;return(null==(b=a.storage)?0:b.estimate)?d.return(a.storage.estimate()):(null==(c=a.webkitTemporaryStorage)?0:c.queryUsageAndQuota)?d.return(ew()):d.return()})};
...
z("ytglobal.storageClass_",dw);function qm(a,b){var c=this;this.handleError=a;this.i=b;this.j=!1;void 0===self.document||self.addEventListener("beforeunload",function(){c.j=!0});
...
t(hw,J);hw.prototype.sendMessage=function(a,b){if(b=b||this.l){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var c=JSON.stringify(a);b.postMessage(c,this.targetOrigin)}catch(d){Nk(d)}}};
hw.prototype.D=function(){window.removeEventListener("message",this.v);J.prototype.D.call(this)};function iw(){this.j=[];this.isReady=!1;this.l={};var a=this.i=new hw(!!L("WIDGET_ID_ENFORCE")),b=this.Xc.bind(this);a.o=b;a.s=null;this.i.channel="widget";if(a=L("WIDGET_ID"))this.i.sessionId=a}
l=iw.prototype;l.Xc=function(a,b,c){"addEventListener"===a&&b?(a=b[0],this.l[a]||"onReady"===a||(this.addEventListener(a,jw(this,a)),this.l[a]=!0)):this.Hb(a,b,c)};
l.Hb=function(){};
function jw(a,b){return function(c){return a.sendMessage(b,c)}}
l.addEventListener=function(){};
l.Kc=function(){this.isReady=!0;this.sendMessage("initialDelivery",this.qb());this.sendMessage("onReady");fb(this.j,this.lc,this);this.j=[]};
l.qb=function(){return null};
...
l.dispose=function(){this.i=null};var lw=new Set("endSeconds startSeconds mediaContentUrl suggestedQuality videoId rct rctn".split(" "));function mw(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
function nw(a,b,c){if("string"===typeof a)return{videoId:a,startSeconds:b,suggestedQuality:c};b={};c=p(lw);for(var d=c.next();!d.done;d=c.next())d=d.value,a[d]&&(b[d]=a[d]);return b}
function ow(a,b,c,d){if(Qa(a)&&!Array.isArray(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};"string"===typeof a&&16===a.length?b.list="PL"+a:b.playlist=a;return b}
;function pw(a){iw.call(this);this.listeners=[];this.api=a;this.addEventListener("onReady",this.onReady.bind(this));this.addEventListener("onVideoProgress",this.hd.bind(this));this.addEventListener("onVolumeChange",this.jd.bind(this));this.addEventListener("onApiChange",this.cd.bind(this));this.addEventListener("onPlaybackQualityChange",this.ed.bind(this));this.addEventListener("onPlaybackRateChange",this.fd.bind(this));this.addEventListener("onStateChange",this.gd.bind(this));this.addEventListener("onWebglSettingsChanged",
this.kd.bind(this))}
t(pw,iw);l=pw.prototype;
l.Hb=function(a,b,c){if(this.api.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&mw(a)){var d=b;if(Qa(d[0])&&!Array.isArray(d[0]))var e=d[0];else switch(e={},a){case "loadVideoById":case "cueVideoById":e=nw(d[0],void 0!==d[1]?Number(d[1]):void 0,d[2]);break;case "loadVideoByUrl":case "cueVideoByUrl":e=d[0];"string"===typeof e&&(e={mediaContentUrl:e,startSeconds:void 0!==d[1]?Number(d[1]):void 0,suggestedQuality:d[2]});b:{if((d=e.mediaContentUrl)&&(d=/\/([ve]|embed)\/([^#?]+)/.exec(d))&&d[2]){d=
d[2];break b}d=null}e.videoId=d;e=nw(e);break;case "loadPlaylist":case "cuePlaylist":e=ow(d[0],d[1],d[2],d[3])}b.length=1;b[0]=e}this.api.handleExternalCall(a,b,c);mw(a)&&kw(this,this.qb())}};
...
l.qb=function(){if(!this.api)return null;var a=this.api.getApiInterface();mb(a,"getVideoData");for(var b={apiInterface:a},c=0,d=a.length;c<d;c++){var e=a[c];if(0===e.search("get")||0===e.search("is")){var f=0;0===e.search("get")?f=3:0===e.search("is")&&(f=2);f=e.charAt(f).toLowerCase()+e.substr(f+1);try{var g=this.api[e]();b[f]=g}catch(h){}}}b.videoData=this.api.getVideoData();b.currentTimeLastUpdated_=Date.now()/1E3;return b};
...
l.ed=function(a){kw(this,{playbackQuality:a})};
l.fd=function(a){kw(this,{playbackRate:a})};
...
l.jd=function(){kw(this,{muted:this.api.isMuted(),volume:this.api.getVolume()})};
...
l.kd=function(){var a={sphericalProperties:this.api.getSphericalProperties()};kw(this,a)};
l.dispose=function(){iw.prototype.dispose.call(this);for(var a=0;a<this.listeners.length;a++){var b=this.listeners[a];this.api.removeEventListener(b.eventType,b.listener)}this.listeners=[]};function qw(a){J.call(this);this.j={};this.started=!1;this.connection=a;this.connection.subscribe("command",this.fc,this)}
t(qw,J);l=qw.prototype;l.start=function(){this.started||this.i()||(this.started=!0,this.connection.va("RECEIVING"))};
l.va=function(a,b){this.started&&!this.i()&&this.connection.va(a,b)};
l.fc=function(a,b,c){if(this.started&&!this.i()){var d=b||{};switch(a){case "addEventListener":"string"===typeof d.event&&this.addListener(d.event);break;case "removeEventListener":"string"===typeof d.event&&this.removeListener(d.event);break;default:this.api.isReady()&&this.api.isExternalMethodAvailable(a,c||null)&&(b=rw(a,b||{}),c=this.api.handleExternalCall(a,b,c||null),(c=sw(a,c))&&this.va(a,c))}}};
l.addListener=function(a){if(!(a in this.j)){var b=this.dd.bind(this,a);this.j[a]=b;this.addEventListener(a,b)}};
l.dd=function(a,b){this.started&&!this.i()&&this.connection.va(a,this.pb(a,b))};
l.pb=function(a,b){if(null!=b)return{value:b}};
l.removeListener=function(a){a in this.j&&(this.removeEventListener(a,this.j[a]),delete this.j[a])};
l.D=function(){var a=this.connection;a.i()||vi(a.j,"command",this.fc,this);this.connection=null;for(var b in this.j)this.j.hasOwnProperty(b)&&this.removeListener(b);J.prototype.D.call(this)};function tw(a,b){qw.call(this,b);this.api=a;this.start()}
t(tw,qw);tw.prototype.addEventListener=function(a,b){this.api.addEventListener(a,b)};
...
tw.prototype.pb=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return qw.prototype.pb.call(this,a,b)};
tw.prototype.D=function(){qw.prototype.D.call(this);delete this.api};function uw(a){a=void 0===a?!1:a;J.call(this);this.j=new K(a);re(this,this.j)}
Za(uw,J);uw.prototype.subscribe=function(a,b,c){return this.i()?0:this.j.subscribe(a,b,c)};
uw.prototype.m=function(a,b){this.i()||this.j.qa.apply(this.j,arguments)};function vw(a,b,c){uw.call(this);this.l=a;this.destination=b;this.id=c}
t(vw,uw);vw.prototype.va=function(a,b){this.i()||this.l.va(this.destination,this.id,a,b)};
vw.prototype.D=function(){this.destination=this.l=null;uw.prototype.D.call(this)};function ww(a,b,c){J.call(this);this.destination=a;this.origin=c;this.j=kq(window,"message",this.l.bind(this));this.connection=new vw(this,a,b);re(this,this.connection)}
t(ww,J);ww.prototype.va=function(a,b,c,d){this.i()||a!==this.destination||(a={id:b,command:c},d&&(a.data=d),this.destination.postMessage(JSON.stringify(a),this.origin))};
ww.prototype.l=function(a){if(!this.i()&&a.origin===this.origin){var b=a.data;if("string"===typeof b){try{b=JSON.parse(b)}catch(d){return}if(b.command){var c=this.connection;c.i()||c.m("command",b.command,b.data,a.origin)}}}};
ww.prototype.D=function(){lq(this.j);this.destination=null;J.prototype.D.call(this)};function xw(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||vb(b);this.assets=a.assets||{};this.attrs=a.attrs||vb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
xw.prototype.clone=function(){var a=new xw,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==Oa(c)?a[b]=vb(c):a[b]=c}return a};var yw=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function zw(a){a=a||"";if(window.spf){var b=a.match(yw);spf.style.load(a,b?b[1]:"",void 0)}else Aw(a)}
function Aw(a){var b=Bw(a),c=document.getElementById(b),d=c&&uv(c,"loaded");d||c&&!d||(c=Cw(a,b,function(){uv(c,"loaded")||(sv(c),Aq(b),fl(Ya(Bq,b),0))}))}
...
function Bw(a){var b=kf("A");Db("This URL is never added to the DOM");fc(b,new Ob(a,Pb));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+kc(a)}
;function Dw(){J.call(this);this.j=[]}
t(Dw,J);Dw.prototype.D=function(){for(;this.j.length;){var a=this.j.pop();a.target.removeEventListener(a.name,a.callback,void 0)}J.prototype.D.call(this)};function Ew(){Dw.apply(this,arguments)}
t(Ew,Dw);function Fw(a,b,c,d){J.call(this);var e=this;this.v=b;this.webPlayerContextConfig=d;this.da=!1;this.api={};this.W=this.s=null;this.K=new K;this.j={};this.R=this.ka=this.elementId=this.xa=this.config=null;this.P=!1;this.m=this.G=null;this.X={};this.Pa=["onReady"];this.lastError=null;this.Ea=NaN;this.J={};this.Qa=new Ew(this);this.T=0;this.l=this.o=a;re(this,this.K);Gw(this);Hw(this);re(this,this.Qa);c?this.T=fl(function(){e.loadNewVideoConfig(c)},0):d&&(Iw(this),Jw(this))}
t(Fw,J);l=Fw.prototype;l.getId=function(){return this.v};
l.loadNewVideoConfig=function(a){if(!this.i()){this.T&&(gl(this.T),this.T=0);var b=a||{};b instanceof xw||(b=new xw(b));this.config=b;this.setConfig(a);Jw(this);this.isReady()&&Kw(this)}};
function Iw(a){var b;a.webPlayerContextConfig?b=a.webPlayerContextConfig.rootElementId:b=a.config.attrs.id;a.elementId=b||a.elementId;"video-player"===a.elementId&&(a.elementId=a.v,a.webPlayerContextConfig?a.webPlayerContextConfig.rootElementId=a.v:a.config.attrs.id=a.v);var c;(null==(c=a.l)?void 0:c.id)===a.elementId&&(a.elementId+="-player",a.webPlayerContextConfig?a.webPlayerContextConfig.rootElementId=a.elementId:a.config.attrs.id=a.elementId)}
l.setConfig=function(a){this.xa=a;this.config=Lw(a);Iw(this);if(!this.ka){var b;this.ka=Mw(this,(null==(b=this.config.args)?void 0:b.jsapicallback)||"onYouTubePlayerReady")}this.config.args?this.config.args.jsapicallback=null:this.config.args={jsapicallback:null};var c;if(null==(c=this.config)?0:c.attrs)a=this.config.attrs,(b=a.width)&&this.l&&(this.l.style.width=Qh(Number(b)||b)),(a=a.height)&&this.l&&(this.l.style.height=Qh(Number(a)||a))};
...
function Nw(a){var b=!0,c=Ow(a);c&&a.config&&(a=Pw(a),b=uv(c,"version")===a);return b&&!!B("yt.player.Application.create")}
function Jw(a){if(!a.i()&&!a.P){var b=Nw(a);if(b&&"html5"===(Ow(a)?"html5":null))a.R="html5",a.isReady()||Qw(a);else if(Rw(a),a.R="html5",b&&a.m&&a.o)a.o.appendChild(a.m),Qw(a);else{a.config&&(a.config.loaded=!0);var c=!1;a.G=function(){c=!0;var d=Sw(a,"player_bootstrap_method")?B("yt.player.Application.createAlternate")||B("yt.player.Application.create"):B("yt.player.Application.create");var e=a.config?Lw(a.config):void 0;d&&d(a.o,e,a.webPlayerContextConfig);Qw(a)};
a.P=!0;b?a.G():(yv(Pw(a),a.G),(b=Tw(a))&&zw(b),Uw(a)&&!c&&z("yt.player.Application.create",null))}}}
function Ow(a){var b=jf(a.elementId);!b&&a.l&&a.l.querySelector&&(b=a.l.querySelector("#"+a.elementId));return b}
function Qw(a){if(!a.i()){var b=Ow(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);if(c){a.P=!1;if(!Sw(a,"html5_remove_not_servable_check_killswitch")){var d;if((null==b?0:b.isNotServable)&&a.config&&(null==b?0:b.isNotServable(null==(d=a.config.args)?void 0:d.video_id)))return}Vw(a)}else a.Ea=fl(function(){Qw(a)},50)}}
function Vw(a){Gw(a);a.da=!0;var b=Ow(a);if(b){a.s=Ww(a,b,"addEventListener");a.W=Ww(a,b,"removeEventListener");var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=a.api,e=0;e<c.length;e++){var f=c[e];d[f]||(d[f]=Ww(a,b,f))}}for(var g in a.j)a.j.hasOwnProperty(g)&&a.s&&a.s(g,a.j[g]);Kw(a);a.ka&&a.ka(a.api);a.K.qa("onReady",a.api)}
function Ww(a,b,c){var d=b[c];return function(){var e=Ja.apply(0,arguments);try{return a.lastError=null,d.apply(b,e)}catch(f){"sendAbandonmentPing"!==c&&(f.params=c,a.lastError=f,Sr(f))}}}
function Gw(a){a.da=!1;if(a.W)for(var b in a.j)a.j.hasOwnProperty(b)&&a.W(b,a.j[b]);for(var c in a.J)a.J.hasOwnProperty(c)&&gl(Number(c));a.J={};a.s=null;a.W=null;b=a.api;for(var d in b)b.hasOwnProperty(d)&&(b[d]=null);b.addEventListener=function(e,f){a.addEventListener(e,f)};
...
function Hw(a){a.addEventListener("WATCH_LATER_VIDEO_ADDED",function(b){Aq("WATCH_LATER_VIDEO_ADDED",b)});
a.addEventListener("WATCH_LATER_VIDEO_REMOVED",function(b){Aq("WATCH_LATER_VIDEO_REMOVED",b)})}
l.addEventListener=function(a,b){var c=this,d=Mw(this,b);d&&(0<=eb(this.Pa,a)||this.j[a]||(b=Xw(this,a),this.s&&this.s(a,b)),this.K.subscribe(a,d),"onReady"===a&&this.isReady()&&fl(function(){d(c.api)},0))};
l.removeEventListener=function(a,b){this.i()||(b=Mw(this,b))&&vi(this.K,a,b)};
function Mw(a,b){var c=b;if("string"===typeof b){if(a.X[b])return a.X[b];c=function(){var d=Ja.apply(0,arguments),e=B(b);if(e)try{e.apply(y,d)}catch(f){Rr(f)}};
a.X[b]=c}return c?c:null}
function Xw(a,b){var c="ytPlayer"+b+a.v;a.j[b]=c;y[c]=function(d){var e=fl(function(){if(!a.i()){try{a.K.qa(b,null!=d?d:void 0)}catch(h){Sr(new Q("PlayerProxy error when creating global callback",{error:h,event:b,playerId:a.v,data:d}))}var f=a.J,g=String(e);g in f&&delete f[g]}},0);
sb(a.J,String(e))};
return c}
l.getPlayerType=function(){return this.R||(Ow(this)?"html5":null)};
l.getLastError=function(){return this.lastError};
function Rw(a){a.cancel();Gw(a);a.R=null;a.config&&(a.config.loaded=!1);var b=Ow(a);b&&(Nw(a)||!Uw(a)?a.m=b:(b&&b.destroy&&b.destroy(),a.m=null));if(a.o)for(a=a.o;b=a.firstChild;)a.removeChild(b)}
l.cancel=function(){this.G&&Ev(Pw(this),this.G);gl(this.Ea);this.P=!1};
l.D=function(){Rw(this);if(this.m&&this.config&&this.m.destroy)try{this.m.destroy()}catch(b){Rr(b)}this.X=null;for(var a in this.j)this.j.hasOwnProperty(a)&&(y[this.j[a]]=null);this.xa=this.config=this.api=null;delete this.o;delete this.l;J.prototype.D.call(this)};
...
function Sw(a,b){if(a.webPlayerContextConfig)var c=a.webPlayerContextConfig.serializedExperimentFlags;else{var d;if(null==(d=a.config)?0:d.args)c=a.config.args.fflags}return"true"===Tk(c||"","&")[b]}
function Lw(a){for(var b={},c=p(Object.keys(a)),d=c.next();!d.done;d=c.next()){d=d.value;var e=a[d];b[d]="object"===typeof e?vb(e):e}return b}
;var Yw={},Zw="player_uid_"+(1E9*Math.random()>>>0);function $w(a,b,c){var d="player";c=void 0===c?!0:c;d="string"===typeof d?jf(d):d;var e=Zw+"_"+Ra(d),f=Yw[e];if(f&&c)return ax(a,b)?f.api.loadVideoByPlayerVars(a.args||null):f.loadNewVideoConfig(a),f.api;f=new Fw(d,e,a,b);Yw[e]=f;Aq("player-added",f.api);se(f,function(){delete Yw[f.getId()]});
return f.api}
...
;function hx(a,b,c){a="ST-"+kc(a).toString(36);b=b?tc(b):"";c=c||5;zs()&&wl(a,b,c)}
;function ix(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=L("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=L("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=oc(window.location.href);g&&f.push(g);g=oc(d);if(0<=eb(f,g)||!g&&0==d.lastIndexOf("/",0))if(M("autoescape_tempdata_url")&&(f=document.createElement("a"),fc(f,d),d=f.href),d&&(d=pc(d),f=d.indexOf("#"),d=0>f?d:d.slice(0,f)))if(e&&!b.csn&&(b.itct||b.ved)&&(b=Object.assign({csn:js()},b)),h){var h=parseInt(h,10);isFinite(h)&&0<h&&
hx(d,b,h)}else hx(d,b)}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var k=void 0===k?{}:k;var m=void 0===m?"":m;var q=void 0===q?window:q;c=q.location;a=vc(a,k)+m;var r=void 0===r?Ph:r;a:{r=void 0===r?Ph:r;for(k=0;k<r.length;++k)if(m=r[k],m instanceof Nh&&m.isValid(a)){r=new Ob(a,Pb);break a}r=void 0}r=r||Sb;if(r instanceof Ob)var x=Qb(r);else{a:if(Fh){try{x=new URL(r)}catch(v){x="https:";break a}x=x.protocol}else b:{x=document.createElement("a");try{x.href=r}catch(v){x=void 0;
break b}x=-1!==[":",""].indexOf(x.protocol)?"https:":x.protocol}x="javascript:"===x?"about:invalid":r}c.href=x}return!0}
;z("yt.setConfig",Dk);z("yt.config.set",Dk);z("yt.setMsg",os);z("yt.msgs.set",os);z("yt.logging.errors.log",Rr);
z("writeEmbed",function(){var a=L("PLAYER_CONFIG");if(!a){var b=L("PLAYER_VARS");b&&(a={args:b})}Js(!0);"gvn"===a.args.ps&&(document.body.style.backgroundColor="transparent");a.attrs||(a.attrs={width:"100%",height:"100%",id:"video-player"});var c=document.referrer;b=L("POST_MESSAGE_ORIGIN");window!==window.top&&c&&c!==document.URL&&(a.args.loaderUrl=c);M("embeds_js_api_set_1p_cookie")&&(c=Yk(window.location.href),c.embedsTokenValue&&(a.args.embedsTokenValue=c.embedsTokenValue));ju();if((c=L("WEB_PLAYER_CONTEXT_CONFIGS"))&&
"WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER"in c){c=c.WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER;if(!c.serializedForcedExperimentIds){var d=Yk(window.location.href);d.forced_experiments&&(c.serializedForcedExperimentIds=d.forced_experiments)}bx=$w(a,c,!1)}else bx=$w(a);bx.addEventListener("onVideoDataChange",ex);bx.addEventListener("onReady",gx);a=L("POST_MESSAGE_ID","player");L("ENABLE_JS_API")?dx=new pw(bx):L("ENABLE_POST_API")&&"string"===typeof a&&"string"===typeof b&&(cx=new ww(window.parent,
a,b),dx=new tw(bx,cx.connection));Hv();M("ytidb_create_logger_embed_killswitch")||pm();a={};cw||(cw=new bw);cw.install((a.flush_logs={callback:function(){Tq()}},a));
M("embeds_web_enable_new_nwl")?Xo():ep();M("ytidb_clear_embedded_player")&&Xh.S(function(){var e;if(!Ru){var f=dt(),g={zb:Qu,pc:Pu};f.providers.set(g.zb,g);g={Ob:{feedbackEndpoint:et(Lu),modifyChannelNotificationPreferenceEndpoint:et(Mu),playlistEditEndpoint:et(Nu),subscribeEndpoint:et(Ju),unsubscribeEndpoint:et(Ku),webPlayerShareEntityServiceEndpoint:et(Ou)}};var h=M("web_enable_client_location_service")?Ss.getInstance():void 0,k={};h&&(k.client_location=h);if(void 0===m){Ks.i||(Ks.i=new Ks);var m=
Ks.i}void 0===e&&(e=f.resolve(Qu));xu(g,e,m,k);m={zb:Cu,qc:wu.i};f.providers.set(m.zb,m);Ru=f.resolve(Cu)}rv()})});
var jx=Lk(function(){qu();var a=zl.getInstance(),b=Cl(119),c=1<window.devicePixelRatio;if(document.body&&ii(document.body,"exp-invert-logo"))if(c&&!ii(document.body,"inverted-hdpi")){var d=document.body;if(d.classList)d.classList.add("inverted-hdpi");else if(!ii(d,"inverted-hdpi")){var e=gi(d);hi(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi"))}}else!c&&ii(document.body,"inverted-hdpi")&&ji();if(b!=c){b="f"+(Math.floor(119/31)+1);d=Dl(b)||0;d=c?d|67108864:d&-67108865;0==d?delete yl[b]:(c=d.toString(16),
yl[b]=c.toString());c=!0;M("web_secure_pref_cookie_killswitch")&&(c=!1);b=a.i;d=[];for(var f in yl)d.push(f+"="+encodeURIComponent(String(yl[f])));wl(b,d.join("&"),63072E3,a.j,c)}av.i||(av.i=new av);a=av.i;f=16623;var g=void 0===g?{}:g;Object.values(ps).includes(f)||(Sr(new Q("createClientScreen() called with a non-page VE",f)),f=83769);g.isHistoryNavigation||a.i.push({rootVe:f,key:g.key||""});a.o=[];a.N=[];g.Rb?dv(a,f,g):ev(a,f,g)}),kx=Lk(function(){bx&&bx.sendAbandonmentPing&&bx.sendAbandonmentPing();
L("PL_ATT")&&(M("use_player_abuse_bg_library")?Qv.dispose():Rv.dispose());for(var a=Xh,b=0,c=Fv.length;b<c;b++)a.fa(Fv[b]);Fv.length=0;Dv("//static.doubleclick.net/instream/ad_status.js");Gv=!1;Dk("DCLKSTAT",0);qe(dx,cx);bx&&(bx.removeEventListener("onVideoDataChange",ex),bx.destroy())});
window.addEventListener?(window.addEventListener("load",jx),window.addEventListener("pagehide",kx)):window.attachEvent&&(window.attachEvent("onload",jx),window.attachEvent("onunload",kx));z("yt.abuse.player.botguardInitialized",B("yt.abuse.player.botguardInitialized")||Sv);z("yt.abuse.player.invokeBotguard",B("yt.abuse.player.invokeBotguard")||Tv);z("yt.abuse.dclkstatus.checkDclkStatus",B("yt.abuse.dclkstatus.checkDclkStatus")||Iv);z("yt.player.exports.navigate",B("yt.player.exports.navigate")||ix);
